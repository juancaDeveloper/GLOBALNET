...
class JSJobsModelJobSeekerPackages extends JSModel {
    ...
    function getJobSeekerPackageById($packageid) {
        ...
        $query = "SELECT package.title ,package.discountstartdate ,package.discountenddate ,package.discountmessage
                        ...
                        ,package.jobsearch ,package.coverlettersallow ,package.savejobsearch ,package.featuredresume
                        ,package.freaturedresumeexpireindays ,package.goldresume ,package.goldresumeexpireindays ,package.applyjobs
    ...
    public function getJobseekerPackageByVmId($productid){
        if( !JSModel::getJSModel(JSJOBSVMS)->{JSJOBSVMSFUN}('UWI4cDBtdmlydHVlbWFyRkUzQTJs') )
            return false;
        $db = JFactory::getDbo();
