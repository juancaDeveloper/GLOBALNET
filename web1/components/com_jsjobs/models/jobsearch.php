...
class JSJobsModelJobSearch extends JSModel {
    ...
    //         $this->_searchoptions = array();
    //         $companies = $this->getJSModel('company')->getAllCompanies(JText::_('Select Company'));
    ...
    //         $shift = $this->getJSModel('shift')->getShift(JText::_('Select Job Shift'));
    //         $currencies = $this->getJSModel('currency')->getCurrency(JText::_('All'));
    ...
    //         $this->_searchoptions['salaryrangefrom'] = JHTML::_('select.genericList', $this->getJSModel('salaryrange')->getJobSalaryRange(JText::_('From'), 1), 'salaryrangefrom', 'class="inputbox jsjobs-cbo" style="width:80px;"' . '', 'value', 'text', '');
    //         $this->_searchoptions['salaryrangeto'] = JHTML::_('select.genericList', $this->getJSModel('salaryrange')->getJobSalaryRange(JText::_('To'), 1), 'salaryrangeto', 'class="inputbox jsjobs-cbo" style="width:80px;"' . '', 'value', 'text', '');
