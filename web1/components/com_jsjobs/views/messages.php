...
class JSJobsMessages {
    ...
    function getAccessDeniedMsg($msgTitle, $msgLang, $isVisitor = 0) {
        ...
        if ($isVisitor == 1) {
            ...
            $html.= '
                    <a href="index.php?option=com_users&view=login" >' . JText::_("Login") . '</a>
                    <a href="index.php?option=com_jsjobs&c=common&view=common&layout=userregister&userrole=1&Itemid='.$itemid.'" >' . JText::_("Register") . '</a>
                    ';
        }
