                        ...
                        <div class="jsjobs-listing-wrapper">
                          <div class="jsjobs-jobs-save">
                            ...
                            <div class="jsjobs-cover-button-area" >
                                ...
                                <a class="js_listing_icon" href="index.php?option=com_jsjobs&task=jobsearch.deletejobsearch&js=<?php echo $search->id; ?>&Itemid=<?php echo $this->Itemid; ?>&<?php echo JSession::getFormToken(); ?>=1">
