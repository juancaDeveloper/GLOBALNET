...
if ($this->config['offline'] == '1') {
    ...
    if ($this->mymessage_allowed == VALIDATE) {
        if ($this->messages) {
                        ...
                        <div class="jsjobs-listing-wrapper"> 
                          <div class="jsjobs-messages-list">
                            <div class="jsjobs-message-title">
                                ...
                                $link = 'index.php?option=com_jsjobs&c=company&view=company&layout=view_company&nav=37&cd=' . $companyaliasid . '&Itemid=' . $this->Itemid; 
                                ?>
                                <span class="jsjobs-message-created">
                                    <span class="js_message_created_title"><?php echo JText::_('Created'); ?> : </span>
                                ...
                                <a class="js_job_anchor" href="<?php echo $link ?>"><?php echo $message->companyname; ?></a>
                                </span>
                            </div>
                            <div class="jsjobs-message-button-area"> 
                                <span class="jsjsobs-message-btn">
                                <?php $link = 'index.php?option=com_jsjobs&c=message&view=message&layout=job_messages&bd=' . $message->jobaliasid . '&Itemid=' . $this->Itemid; ?>
            ...
            <form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=message&view=message&layout=empmessages&Itemid=' . $this->Itemid ,false); ?>" method="post">
