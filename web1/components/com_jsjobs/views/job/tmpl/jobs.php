...
<?php
require_once('tellafriend.php' );
require_once('jobshortlist.php');
require_once('jobapply.php' );
require_once('jobquickview.php' );
...
$html = '<style type="text/css">
    	...
    	if($showNumOfJobs){
    		echo '<div class="totaljobsheading">'.(JText::_("Total Jobs").': <span>'.$this->totalnumofjobs).'</span></div>';
    	}
    	?>
    	</div>
		<?php
	...
	<?php /*  // pagination  of joomla
	<form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=job&view=job&layout=listnewestjobs&Itemid='.$this->Itemid ,false); ?>" method="post">
	...
	*/ ?>
            <?php if ($this->config['job_rss'] == 1) { ?>
                <div id="rss">
                    <a href="index.php?option=com_jsjobs&c=rss&view=rss&layout=rssjobs&format=rss&Itemid=<?php echo $this->Itemid; ?>" target="_blank"><img width="24" height="24" src="<?php echo JURI::root();?>components/com_jsjobs/images/rss.png" text="Job RSS" alt="Job RSS" /></a>
                </div>
            <?php
            }
