                ...
                if (isset($this->application)) {
                            ...
                            <div class="jsjobs-main-wrapper-appliedjobslist">
                                ...
                                <div class="jsjobs-data-area">
                                    ...
                                    <div class="jsjobs-data-2"> <?php
                                        ...
                                        ?>
                                        <span class="jsjobs-shortlist">
                                            <?php
                                            if ($this->config['show_applied_resume_status'] == 1) { 
                                                if ($job->resumestatus == 4) { ?>
                                                    <div class="js_job_publish rejected"><canvas class="canvas_white_bg" width="20" height="20"></canvas><span class="title"> <?php echo JText::_('Rejected'); ?></span></div>
                                                <?php } elseif ($job->resumestatus == 3) { ?>
                                                    <div class="js_job_publish publish"><canvas class="canvas_white_bg" width="20" height="20"></canvas><span class="title"> <?php echo JText::_('Hired'); ?></span></div>
                                                <?php } elseif ($job->resumestatus == 5) { ?>
                                                    <div class="js_job_publish pending"><canvas class="canvas_white_bg" width="20" height="20"></canvas><span class="title"> <?php echo JText::_('Shortlist'); ?></span></div>
                                                <?php } elseif ($job->resumestatus == 2) { ?>
                                                    <div class="js_job_publish expired"><canvas class="canvas_white_bg" width="20" height="20"></canvas><span class="title"> <?php echo JText::_('Spam');  ?></span></div>
                                                    <?php
                                                }
                                            } 
                                            ?>
                    ...
                    <div class="jsjobs-data-title-cover info_<?php echo $job->id;?>">
                        <span class="jsjobs-resume-data">
                            <span class="jsjobs-resume-title"><?php echo JText::_("Resume");?>:&nbsp;</span>
                            <?php $resumealiasid = $this->getJSModel('common')->removeSpecialCharacter($job->resumealiasid); ?>
