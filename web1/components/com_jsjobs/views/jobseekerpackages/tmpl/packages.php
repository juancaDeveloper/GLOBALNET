            ...
            if (isset($this->packages) AND (!empty($this->packages))) {
             ...
             <div class="jsjobs-package-data">
                ...
                <span class="jsjobs-package-values">
                        ...
                        <span class="stats_data_value"><?php if ($package->featuredresume == -1)
                         echo JText::_('Unlimited');
                         else
                         echo $package->featuredresume;
                        ?>
                        </span>
                         <span class="stats_data_values">( <?php echo $package->freaturedresumeexpireindays.' '.JText::_('Days'); ?> )</span>
                </span>
                </div>
                <div class="jsjobs-package-data-detail">
                <span class="jsjobs-package-values">
                        <span class="stats_data_title"><?php echo JText::_('Gold Resumes'); ?>:</span>
                        <span class="stats_data_value"><?php if ($package->goldresume == -1)
                    echo JText::_('Unlimited');
                else
                    echo $package->goldresume;
                        ?></span>
                        <span class="stats_data_values">( <?php echo $package->goldresumeexpireindays.' '.JText::_('Days');  ?> )</span>
                        </span>
                        </div>
                        <div class="jsjobs-package-data-detail">
                        <span class="jsjobs-package-values">
