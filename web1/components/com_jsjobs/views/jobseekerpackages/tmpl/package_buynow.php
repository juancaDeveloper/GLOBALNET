    ...
    if (isset($this->userrole->rolefor) && $this->userrole->rolefor == 2) { // employer
        ...
        <form action="index.php" method="post" name="adminForm">
                               ...
                               <div class="jsjobs-package-data-detail">
                                ...
                                <div class="jsjobs-package-data-detail">
                                    <span class="jsjobs-package-values">
                                        ...
                                        <span class="stats_data_value">
                                            <?php 
                                                if ($this->package->featuredresume == -1)
                                                   echo JText::_('Unlimited');
                                                else
                                                   echo $this->package->featuredresume;
                                            ?>
                                        </span>
                                        <span class="stats_data_values">( <?php echo JText::_('Expire in') .' '. $this->package->freaturedresumeexpireindays.' '.JText::_('Days'); ?> )</span>
                                    </span>
                                </div>
                                <div class="jsjobs-package-data-detail">
                                    <span class="jsjobs-package-values">
                                        ...
                                        <span class="stats_data_value">
                                            <?php 
                                                if ($this->package->goldresume == -1)
                                                    echo JText::_('Unlimited');
                                                else
                                                    echo $this->package->goldresume;
                                           ?>
                                        </span>
                                        <span class="stats_data_values">( <?php echo JText::_('Expire in') .' '. $this->package->goldresumeexpireindays.' '.JText::_('Days');  ?> )</span>
                                    </span>
                                </div>
                                <div class="jsjobs-package-data-detail">
                                    <span class="jsjobs-package-values">
            ...
            <?php if ($showpaymentmethod == true) {
                ...
                ?>
                        <?php
                         if( $this->package->virtuemartproductid && $this->getJSModel(VIRTUEMARTJSJOBS)->{VIRTUEMARTJSJOBSFUN}('Z0FGdmtzdmlydHVlbWFybFpoQnBT') ){
