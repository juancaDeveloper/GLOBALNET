                           ...
                           <div class="jsjobs-listing-datawrap">
                            ...
                            <div class="jsjobs-package-data-detail">
                                <span class="jsjobs-package-values">
                                    ...
                                    <span class="stats_data_value">
                                        <?php if ($package->featuredcompaines == -1)
                                            echo JText::_('Unlimited');
                                        else
                                            echo $package->featuredcompaines;
                                        ?>
                                    </span>
                                      <span class="stats_data_values">( <?php echo $package->featuredcompaniesexpireindays.' '.JText::_('Days'); ?> )</span>
                                </span>
                            </div>
                            <div class="jsjobs-package-data-detail">
                                <span class="jsjobs-package-values">
                                    ...
                                    <span class="stats_data_value">
                                        <?php if ($package->goldcompanies == -1)
                                            echo JText::_('Unlimited');
                                        else
                                            echo $package->goldcompanies;
                                        ?>
                                    </span>
                                    <span class="stats_data_values">( <?php echo $package->goldcompaniesexpireindays.' '.JText::_('Days'); ?> )</span>
                                </span>
                            </div>
                            <div class="jsjobs-package-data-detail">
                                <span class="jsjobs-package-values">
                                    ...
                                    <span class="stats_data_value">
                                        <?php if ($package->featuredjobs == -1)
                                            echo JText::_('Unlimited');
                                        else
                                            echo $package->featuredjobs;
                                        ?>
                                    </span>
                                </span>
                            </div>
                            <div class="jsjobs-package-data-detail">
                                <span class="jsjobs-package-values">
                                    ...
                                    <span class="stats_data_value">
                                        <?php if ($package->goldjobs == -1)
                                            echo JText::_('Unlimited');
                                        else
                                            echo $package->goldjobs;
                                        ?>
                                    </span>
                                </span>
                            </div>
                            <div class="jsjobs-package-data-detail">
                                <span class="jsjobs-package-values bordernone">
                                    ...
                                    <span class="stats_data_value">
                                       <?php if ($package->saveresumesearch == 1)
                                           $imgscr  = JURI::root().'components/com_jsjobs/images/publish-icon.png' ;
                                               else
                                            $imgscr  = JURI::root().'components/com_jsjobs/images/reject-s.png' ;
                                        ?> 
                            ...
                            <?php
                                $curdate = date('Y-m-d H:i:s');
                                if (($package->discountstartdate <= $curdate) && ($package->discountenddate >= $curdate)) {?>
                          <?php      if ($package->discountmessage != '') {?>
