                                ...
                                <?php if ($department->status == 0) { ?>
                                 ...
                                 <div class="jsjobs-main-department-right">
                                    <div class="jsjobs-coverletter-button-area" >
                                        ...
                                        <a class="js_listing_icon" href="index.php?option=com_jsjobs&task=department.deletedepartment&pd=<?php echo $department->aliasid; ?>&Itemid=<?php echo $this->Itemid; ?>&<?php echo JSession::getFormToken(); ?>=1" title="<?php echo JText::_('Delete'); ?>">
