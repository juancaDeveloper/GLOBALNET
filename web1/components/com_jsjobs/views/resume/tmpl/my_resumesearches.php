                        ...
                        <div class="jsjobs-listing-wrapper">
                          <div class="jsjobs-resumesearch-list">
                            ...
                            <div class="jsjobs-coverletter-button-area" >
                                ...
                                <a class="jsjobs-savesearch-btn" href="index.php?option=com_jsjobs&task=resumesearch.deleteresumesearch&rs=<?php echo $search->id; ?>&Itemid=<?php echo $this->Itemid; ?>&<?php echo JSession::getFormToken(); ?>=1">
