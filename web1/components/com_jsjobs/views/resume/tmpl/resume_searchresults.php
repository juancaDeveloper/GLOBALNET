...
<?php
    if ($this->result != false) {
        if ($this->resumes) {
            if ((JFactory::getUser()->guest && $this->config['visitorview_emp_resumesearch']==1) || $this->userrole->rolefor == 1) { // visitor with permission or employer
                        ...
                        if (isset($this->searchresumeconfig['search_resume_showsave']) AND ( $this->searchresumeconfig['search_resume_showsave'] == 1)) {
                            ...
                            <div id="savesearch-form">
                                <form action="index.php" method="post" name="adminForm" id="adminForm" >
                                    ...
                                    <input type="hidden" name="searchcriteria" value="<?php echo base64_encode(json_encode($this->forsavesearch)); ?>" />
