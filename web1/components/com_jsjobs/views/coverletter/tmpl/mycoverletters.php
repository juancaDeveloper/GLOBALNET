                                ...
                                <div class="jsjobs-coverletter-button-area" >
                                    ...
                                    <div class="jsjobs-icon">
                                        <div class="jsjobs-icon-btn">
                                            ...
                                            <a href="index.php?option=com_jsjobs&task=coverletter.deletecoverletter&cl=<?php echo $letter->aliasid; ?>&Itemid=<?php echo $this->Itemid; ?>&<?php echo JSession::getFormToken(); ?>=1" onclick=" return confirmdeletecoverletter();" title="<?php echo JText::_('Delete'); ?>">
