...
$style = "
	...
	div.companies.filterwrapper{background: ".$color3.";border-bottom:2px solid ".$color5.";}
	div.companies.filterwrapper span.filterlocation img{border:1px solid ".$color5.";border-bottom: none;}
	div.companies.filterwrapper span.filterlocation ul.jsjobs-input-list-jsjobs{border:1px solid ".$color5.";}
	div.companies.filterwrapper input#companyname{background:#FFFFFF;border:1px solid ".$color5.";}
	div.companies.filterwrapper input.jsjobs-go{background:".$color6.";border:1px solid ".$color5.";color:".$color8.";}
	div.companies.filterwrapper input.jsjobs-go:hover{background:".$color1.";color:".$color7.";}
	div.companies.filterwrapper input.jsjobs-reset{background:".$color6.";border:1px solid ".$color5.";color:".$color8.";}
	div.companies.filterwrapper input.jsjobs-reset:hover{background:".$color1.";color:".$color7.";}
	...
	div#jsjobs-wrapper div.totaljobsheading{color:".$color4.";border:1px solid ".$color5.";background:".$color3.";}
	...
	div#js_main_wrapper div div.js-resume-section-body div div.js-resume-section-view div.js-resume-profile-info div.js-resume-print-wrap a{border:1px solid ".$color5.";background:".$color3.";}
	div#js_main_wrapper div div.js-resume-section-body div div.js-resume-section-view div.js-resume-profile-info div.js-resume-print-wrap a:hover{border-color:".$color2.";}
	...
	div#resumeform div.jssection_wrapper{ border-bottom:2px solid ".$color2.";}
	div#resumeform div.jssection_wrapper:last-child{border-bottom: none;}
	div#resumeform div.jssectionwrapper{background:".$color3."; border: 1px solid ".$color5."; border-top: none;}
	div#resumeform div.jssectionwrapper div.resumefieldswrapper div.jsresume_seach_width{border: 1px solid ".$color5.";}
	div#resumeform div.jssectionwrapper div.resumefieldswrapper .resumefieldtitle{color:".$color8.";}
	div#resumeform div.jssectionwrapper div.resumefieldswrapper .resumefieldvalue div.photowrapper{border:1px solid ".$color4.";}
	...
	div#resumeform div.jssectionwrapper div.resumefieldswrapper div.files-field div.selectedFiles{border:1px solid ".$color5.";}
	...
	div#resumeform div.resumesubmitbuttons .resume_submits{ border: 1px solid ".$color5."; background: ".$color7."; color: ".$color8.";}
	div#resumeform div.resumesubmitbuttons .resume_submits:hover{ background: ".$color1."; color: ".$color7.";}
	div#resumeform div.jssection_wrapper div.jsundodiv{background: rgba(".$resumeundo.",0.6);}
	div#resumeform div.jsresume_addnewbutton{background:".$color6."; border: 1px solid ".$color5."; color: ".$color8."; }
	...
	div#js_resume_percentage{border: 1px solid ".$color5."; border-top:none; background: ".$color3.";}
	div#js_resume_percentage div.js_detail_area div.js-heading{color:".$color8.";}
	div#js_resume_percentage div.js_detail_area div.js-percentage div.js-percentage-status{background:".$color2.";}
	div#js_resume_percentage div.js_image_area span.profile-img{border: 2px solid ".$color2.";}
	...
	div.js-topresume-area{background: ".$color3."; border-bottom: 1px solid ".$color5.";}
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.jsjobs-img-area{background: ".$color3."; border-bottom: 1px solid ".$color5.";}
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.js-topresume-area div.jsjobs-applyname{border-bottom: 1px solid ".$color5.";}
	...
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.js-topresume-area div.jsjobs-applyname span.jsjobs-fulltime-btn{color:".$color4."; border: 1px solid ".$color5."; border-bottom: none;}
	...
	div#js-jobs-resumelisting-wrapper div.jsjobs-myresume-buttons{ background : ".$color3."; border-top: 1px solid ".$color5."; color: ".$color8.";}
	div#js-jobs-resumelisting-wrapper div.jsjobs-myresume-buttons span.jsjobs-myresumebtn a.jsjobs-myresumes-btn{background : ".$color7."; border: 1px solid ".$color5."; }
	div#js-jobs-resumelisting-wrapper div.jsjobs-myresume-buttons span.jsjobs-myresumebtn a.jsjobs-myresumes-btn:hover{ border: 1px solid ".$color1."; }

	div.myresume-complete-status div.complete-status-wrapper{ background: ".$color3."; border: 1px solid ".$color5."; }
	div.myresume-complete-status div.complete-status-wrapper div.myresume-title{ border-bottom: 1px solid ".$color5."; }
	div.myresume-complete-status div.complete-status-wrapper div.myresume-graph{ background: ".$color7."; border-bottom: 1px solid ".$color5."; }
	div.myresume-complete-status div.complete-status-wrapper div.myresume-info{}
	div.myresume-complete-status div.complete-status-wrapper div.myresume-graph .mytext{color : ".$color4.";}
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.jsjobs-img-area div.js-myresume-last-modified{color : ".$color4.";}
	
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.jsjobs-resume-data-area div.myresume-complete-status div.js-mr-rp div.circle div.mask.half div.fill.fix{background: ".$color1.";}
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.jsjobs-resume-data-area div.myresume-complete-status .js-mr-rp .circle .mask .fill{background: ".$color1.";}
	div#js-jobs-resumelisting-wrapper div.js-resume-list div.jsjobs-resume-data-area div.myresume-complete-status .js-mr-rp .inset .percentage .numbers span{color: ".$color1.";}
...
function hex2rgb($hex) {$hex = str_replace("#", "", $hex); if(strlen($hex) == 3) {$r = hexdec(substr($hex,0,1).substr($hex,0,1)); $g = hexdec(substr($hex,1,1).substr($hex,1,1)); $b = hexdec(substr($hex,2,1).substr($hex,2,1)); } else {$r = hexdec(substr($hex,0,2)); $g = hexdec(substr($hex,2,2)); $b = hexdec(substr($hex,4,2)); } $rgb = array($r, $g, $b); return implode(",", $rgb);}
