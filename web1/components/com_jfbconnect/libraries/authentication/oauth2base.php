...
class JFBConnectAuthenticationOauth2Base
{
    ...
    public function __construct(JRegistry $options = null, JHttp $http = null, JInput $input = null, JApplicationWeb $application = null)
    {
        ...
        $this->clientIdField = 'client_id';
        $this->clientSecretField = 'client_secret';
    }

    public function setClientFields($clientId, $clientSecret)
    {
        $this->clientIdField = $clientId;
        $this->clientSecretField = $clientSecret;
    }
    ...
    public function createUrl()
    {
        ...
        $url .= '&'.$this->clientIdField.'=' . urlencode($this->getOption('clientid'));
