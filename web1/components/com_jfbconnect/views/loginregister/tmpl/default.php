    ...
    <div id="jfbc_loginregister_userinfo" class="<?php echo $this->displayType; ?>">
            ...
            <form action="" method="post" name="form" autocomplete="on">
                <fieldset>
                    ...
                    <dl>
                        ...
                        <dt></dt>
                        <dd><input type="submit" class="btn <?php echo $this->configModel->getSetting('registration_loginbutton_class', 'btn-primary');?>" value="<?php echo JText::_('COM_JFBCONNECT_LOGIN'); ?>" />
                        </dd>
                    </dl>
                </fieldset>
        ...
        <div id="jfbc_loginregister_newuser" class="<?php echo $newUserSpan;?>">
            <form action="" method="post" id="adminForm" class="form-validate" autocomplete="on">
                    ...
                    <?php if (count($fields))
                    {
                        ...
                        <fieldset>
                            ...
                            { // If the fieldset has a label set, display it as the legend.
                                ...
                                <?php if(!$addedDesc) {
                                    echo '<p>'.JText::sprintf('COM_JFBCONNECT_NEW_USER_INSTRUCTIONS', ucfirst($this->providerName)).'</p>';
                                    $addedDesc = true;
                                }?>
                            <?php } ?>
                            <dl>
                ...
                <input type="submit" class="btn validate <?php echo $this->configModel->getSetting('registration_registerbutton_class', 'btn-secondary');?>" value="<?php echo JText::_('COM_JFBCONNECT_REGISTER') ?>" />
