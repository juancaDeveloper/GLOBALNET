...
Object.assign(MediaElementPlayer.prototype, {
    ...
    buildme: function buildme( player, controls, layers, media ) {
		...
		if( t.validate( t.options.pluginPath, t.options.licenseKey ) ) {
			...
			player.meLayer.innerHTML = '<a href="https://allvideoshare.mrvinoth.com/" target="_blank" style="position:absolute; padding:5px 6px; background-color:#f89406; color:#fff; font-family:\'Verdana\'; font-size:12px; text-decoration:none; top:10px; left:10px; border-radius:2px; z-index:9999999; cursor:pointer; opacity: 0.8">Powered by MrVinoth.com</a>';
		}
