...
class plgContentjsgoldcompanies extends JPlugin {  // for joomla 1.5
    ...
    protected function _load($position, $style = -2) {
        ...
        //sce
        $jobresult = JSModel::getJSModel('company')->getGoldCompanies($result['noofjobs'], $result['theme']);
        $result['companies'] = $jobresult[0];
        ...
        $result['color'] = $color;
            ...
            //print_r($result);
            //die();
            $classname = 'jsgoldcompanies'.uniqid();
