...
class plgContentJSHotJobs extends JPlugin {   // for joomla 1.5
    ...
    protected function _load($position, $style = -2) {
        ...
        //sce
        $jobresult = JSModel::getJSModel('job')->getHotJobs($result['noofjobs'],$result['theme']);
