...
echo '<div class="tlp-team-wrap">';
    ...
    $html .='<div class="isotop-container isotope5">';
        ...
        foreach ($rows as &$item) : 
            ...
            $html .='<div class="team-item cat'.$item->department.' '.$bss.' '.$item_margin.' tlp-equal-height">';
			if (!empty($item->profile_image)):
			   	$html .='<div class="single-team-area'. $image_style_class.'">'; 
			       	$html .='<div class="tlp-portfolio-thum">';  
			           $html .='<figure>';
			            if($link_detail==1){
