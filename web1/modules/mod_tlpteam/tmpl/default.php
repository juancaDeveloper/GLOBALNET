...
if($bootstrap_version==3){
    $bss="col-md-".$md_grid." col-lg-".$md_grid." col-sm-".$sm_grid. " col-xs-".$xs_grid;
      if($display_no==2){
          $image_area="col-md-5 col-lg-5 col-sm-6 paddingl0";
          $content_area="col-md-7 col-lg-7 col-sm-6 paddingr0";
      }else{
          $image_area="col-md-3 col-lg-3 col-sm-12 paddingl0";
          $content_area="col-md-9 col-lg-9 col-sm-12 paddingr0";
      }
  }else{
    $bss="tlp-col-md-".$md_grid." tlp-col-lg-".$md_grid." tlp-col-sm-". $sm_grid. " tlp-col-xs-".$xs_grid;
      if($display_no==2){
          $image_area="tlp-col-md-5 tlp-col-lg-5 tlp-col-sm-6 ";
          $content_area="tlp-col-md-7 tlp-col-lg-7 tlp-col-sm-6 ";
      }else{
          $image_area="tlp-col-md-3 tlp-col-lg-3 tlp-col-sm-12 ";
          $content_area="tlp-col-md-9 tlp-col-lg-9 tlp-col-sm-12 ";
      }
  }
...
$style  = '.tlp-team .skill-prog .fill, .tlp-tooltip + .tooltip > .tooltip-inner, .tlp-team .layout1 .tlp-content-layout1, .tlp-popup-wrap .tlp-popup-navigation-wrap { background: ' . $primary_color . '; }';
...
$style .= '.tlp-team .social-icons a { background: ' . $social_icon_background . '; color: '. $social_icon_color. '; font-size: '. $social_icon_size .'px; }';
...
$style .= '.tlp-team .layout1 .short-bio { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
...
echo '<div class="tlp-team-wrap">';
	...
	$html .='<div class="tlp-team tlp-team">';
		$html .='<div class="tlp-row layout1">';
		foreach ($rows as &$item) : 
			...
			$html .='<div class="'.$bss .' '.$item_margin.' tlp-equal-height">';	
