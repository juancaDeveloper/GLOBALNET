...
$style .= '.tlp-team .isotope1 .team-item h3 a, .tlp-team .isotope1 .team-item h3{ color: ' . $name_font_color . '; font-size: '. $name_font_size. 'px; text-align: '. $name_text_align .'; }';
...
$style .= '.tlp-team .isotope1 .overlay .short-bio p, .tlp-team .isotope1 .overlay .short-bio p a { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
...
echo '<div class="tlp-team-wrap">';
	...
	$html .='<div class="isotop-container isotope1">';
