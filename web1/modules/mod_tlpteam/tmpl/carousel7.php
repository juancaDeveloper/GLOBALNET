...
$style .= '.tlp-team .layout10 { margin: 30px 0px; }';
$style .= '.tlp-team .layout10 .tlp-overlay .tlp-title h3,.tlp-team .layout10 .tlp-overlay .tlp-title h3 a,.tlp-team .layout10 .tlp-team-item .tlp-info h3,.tlp-team .layout10 .tlp-team-item .tlp-info h3 a { color: ' . $name_font_color . '; font-size: '. $name_font_size. 'px; text-align: '. $name_text_align .'; }';
$style .= '.tlp-team .layout10 .tlp-position { color: ' . $position_font_color . '; font-size: '. $position_font_size. 'px; text-align: '. $position_text_align .'; }';
$style .= '.tlp-team .layout10 .tlp-overlay p { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
...
echo '<div class="tlp-team-wrap container-fluid">';
	...
	$html .='<div class="tlp-team mod-tlp-team-carousol">';
		$html .='<div class="tlp-row layout10">';
