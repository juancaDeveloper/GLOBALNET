...
$style .= '.tlp-team .layout8 .tlp-overlay .tlp-position,.tlp-team .layout8 .tlp-overlay .tlp-position a { color: ' . $position_font_color . '; font-size: '. $position_font_size. 'px ; text-align: '. $position_text_align .'; }';
...
$style .= '.tlp-team .layout8 .tlp-overlay .tlp-content { padding-top: ' . $overlay_item_padding . '%; }';
if($gutter){
...
$html .='<div class="tlp-team">';
	$html .='<div class="tlp-row layout8">';
