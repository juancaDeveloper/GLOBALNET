...
$style .= '.tlp-team .layout12 .single-team-area h3 span.team-name { background:'.$primary_color.';}';
...
$style .= '.tlp-team .layout12 .tlp-content p { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
...
echo '<div class="tlp-team-wrap container-fluid">';
	...
	$html .='<div class="tlp-team mod-tlp-team-carousol">';
		$html .='<div class="tlp-row layout12">';
