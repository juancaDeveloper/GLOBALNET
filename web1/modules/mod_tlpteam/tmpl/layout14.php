...
$style .= '.tlp-team .layout14 .item-info p,.tlp-team .layout14 .item-info p a { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
...
if($mod_pretext){
	...
	$html .='<div class="tlp-team">';
		$html .='<div class="tlp-row layout14">';
