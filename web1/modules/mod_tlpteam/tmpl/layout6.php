...
if($bootstrap_version==3){
    ...
    $image_area="col-md-6 col-lg-6 col-sm-6 paddingl0";
    $content_area="col-md-6 col-lg-6 col-sm-6 paddingr0";  
  }else{
...
$style .= '.tlp-team .layout6 h3,.tlp-team .layout6 h3 a { color: ' . $name_font_color . '; font-size: '. $name_font_size. 'px; text-align: '. $name_text_align .'; }';
$style .= '.tlp-team .layout6 .tlp-position { color: ' . $position_font_color . '; font-size: '. $position_font_size. 'px; text-align: '. $position_text_align .'; }';
$style .= '.tlp-team .layout6 .short-bio { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
$style .='.tlp-team .layout6 .tlp-info-block { background:'. $primary_color.';}';
	...
	$html .='<div class="tlp-team">';
		$html .='<div class="layout6">';
			...
			foreach ($rows as &$item) {
				...
				$detail_link = JRoute::_('index.php?option=com_tlpteam&view=team&id='.$item->id.':'.$item->alias);
				$j++;
			if($k== 1){
			...
			if($l8 == 0){
			    $html .='<div class="'.$image_area.' tlp-img-block">';
			    	$html .='<div class="tlp-img tlp-single-team">';
