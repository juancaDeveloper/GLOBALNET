...
$style .= '.tlp-team .layout11 .tlp-content p { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
$style .= '.tlp-team .layout11 .single-team-area .tlp-title { background-color: rgba(' . $r.','.$g.','.$b . ','.$overlay_opacity.'); }';
}
$style .='.tlp-team .layout11 .single-team-area .social-icons { padding-top:'.$overlay_item_padding.'%;}';
$style .= '.owl-theme .owl-controls .owl-buttons div { background:' .$btn_bg. '; color: '.$btn_text_color.';}';
$style .= '.owl-theme .owl-controls .owl-buttons div:hover { background:' .$btn_bg_hover. '; color: '.$btn_text_color.';}';
...
echo '<div class="tlp-team-wrap container-fluid">';
	...
	$html .='<div class="tlp-team mod-tlp-team-carousol">';
		$html .='<div class="tlp-row layout11">';
