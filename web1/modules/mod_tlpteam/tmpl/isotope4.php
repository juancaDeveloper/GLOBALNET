...
$style .= '.tlp-team .isotope4 .tlp-team-item:hover h3, .tlp-team .isotope4 .tlp-team-item:hover h3 a { color: ' . $name_font_color . '; font-size: '. $name_font_size. 'px; text-align: '. $name_text_align .'; }';
$style .= '.tlp-team .isotope4 .tlp-team-item .tlp-position,.tlp-team .isotope4 .tlp-team-item .tlp-position a { color: ' . $position_font_color . '; font-size: '. $position_font_size. 'px; text-align: '. $position_text_align .'; }';
$style .= '.tlp-team .isotope4 .tlp-team-item .short-bio p,.tlp-team .isotope4 .tlp-team-item .short-bio p a { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
...
echo '<div class="tlp-team-wrap">';
    ...
    $html .='<div class="isotop-container isotope4">';
