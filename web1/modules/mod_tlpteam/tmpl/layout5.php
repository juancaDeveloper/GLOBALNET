...
if (!empty($rows)) :
echo '<div class="tlp-team-wrap tlp-team">';
	if($mod_pretext){
		$html .='<p class="module-pretext">'.$mod_pretext.'</p>';
	}
	$html .='<div class="single-team layout5">';
		$html .='<table class="row table table-striped table-responsive '.$image_style_class.'">';
		foreach ($rows as &$item) :
			...
			$html .='<tr>
				...
				if($email_field==1){
				$html .='<td class="alignmiddle">';
					$html .='<i class="fa fa-envelope-o"></i> <span><a href="mailto:'.$item->email.'">'.$item->email.'</a></span>'; 
				$html .='</td>';
				}
				if($phoneno_field==1){
				$html .='<td class="alignmiddle">';
					$html .='<i class="fa fa-phone"></i> <span>'.$item->phoneno.'</span>';
				$html .='</td>';
				}
				if($mobileno_field==1){
				$html .='<td class="alignmiddle">';
					$html .='<i class="fa fa-mobile"></i> <span>'.$item->mobileno.'</span>';
				$html .='</td>';
				}
