...
$style .= '.tlp-team .layout3 .short-bio { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
$style .= '.tlp-team .layout3 .overlay { background-color: rgba(' . $r.','.$g.','.$b . ','.$overlay_opacity.'); }';
}
...
echo '<div class="tlp-team-wrap container-fluid">';
	...
	$html .='<div class="tlp-team mod-tlp-team-carousol">';
		$html .='<div class="tlp-row layout3">';
