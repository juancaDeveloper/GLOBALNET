...
$style .= '.tlp-team .isotope3 .tlp-position,.tlp-team .isotope3 .tlp-position a { color: ' . $position_font_color . '; font-size: '. $position_font_size. 'px; text-align: '. $position_text_align .'; }';
$style .= '.tlp-team .isotope3 .short-bio p,.tlp-team .isotope3 .short-bio p a { color: ' . $short_bio_font_color . '; text-align: '. $short_bio_text_align .'; }';
if($overlay_color){
...
echo '<div class="tlp-team-wrap">';
    ...
    $html .='<div class="isotop-container isotope3">';
