...
$showType = $params->get('show_type');
$isMobileDevice = JFactory::getApplication()->client->mobile;

//If Mobile and selected to show only on desktop
//If Desktop and selected to show only on mobile
if(($isMobileDevice && $showType == 'desktop') || (!$isMobileDevice && $showType == 'mobile'))
    return;
