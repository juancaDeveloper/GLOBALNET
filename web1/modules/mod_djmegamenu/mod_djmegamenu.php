...
if($isJoomla4) {
	require_once 'Helper/ModMenuHelper.php';
} else {
...
if($params->get('fa', 1) == 5) {
	$doc->addStyleSheet("https://use.fontawesome.com/releases/v5.13.0/css/all.css");
	$doc->addStyleSheet("https://use.fontawesome.com/releases/v5.13.0/css/v4-shims.css");
	//$doc->addScript("https://use.fontawesome.com/releases/v5.3.1/js/all.js", 'text/javascript', $canDefer);
	//$doc->addScript("https://use.fontawesome.com/releases/v5.3.1/js/v4-shims.js", 'text/javascript', $canDefer);
} else if($params->get('fa', 1)) {
