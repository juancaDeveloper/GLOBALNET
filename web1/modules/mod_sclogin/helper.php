...
// common for J!, JomSocial, and Virtuemart
    ...
    function getIconClass($icon)
    {
        ...
        {
            case 'eye':
                $iconClass = $useFontAwesome ? 'fa fa-eye' : 'icon-eye';
                break;
            case 'eye-slash':
                $iconClass = $useFontAwesome ? 'fa fa-eye-slash' : 'icon-eye-close';
                break;
            case 'question':
                $iconClass = $useFontAwesome ? 'fa fas fa-question-circle' : 'icon-question-sign';
                break;
            default:
                $iconClass = '';
                break;
