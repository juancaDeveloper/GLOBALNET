...
class modJSJobsCountryHelper{
    ...
    public static function getData($params){
        ...
        $result['showonlycountryhavejobs'] = $params->get('scohj', 1);
        ...
        $result['slidingleftwidth'] = $params->get('slidingleftwidth', '768');
        ...
        $result['slidingdirection'] = $params->get('slidingdirection','0'); // 0 = left  , 1=up
        //sce
        $jobresult = JSModel::getJSModel('countries')->getJobsCountry($result['showonlycountryhavejobs'],$result['theme'],$result['noofrecord']);
        $result['countries'] = $jobresult[0];
