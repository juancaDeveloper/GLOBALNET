...
class modJSJobsStatesHelper{
    ...
    public static function getData($params){
        ...
        $result['showonlystatehavejobs'] = $params->get('ssthj', 1);
        ...
        //sce
        $jobresult = JSModel::getJSModel('states')->getJobsStates($result['showonlystatehavejobs'], $result['theme'], $result['noofrecord']);
        $result['states'] = $jobresult[0];
