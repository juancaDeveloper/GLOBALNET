...
INSERT INTO  `#__js_job_paymentmethodconfig` (`configname` ,`configvalue` ,`configfor`) VALUES ('password_paypal',  '',  'paypal');

INSERT INTO  `#__js_job_paymentmethodconfig` (`configname` ,`configvalue` ,`configfor`) VALUES ('lang_paypal',  '',  'paypal');

INSERT INTO  `#__js_job_paymentmethodconfig` (`configname` ,`configvalue` ,`configfor`) VALUES ('logo_paypal',  '',  'paypal');
...
INSERT IGNORE INTO `#__js_job_config` (`configname`, `configvalue`, `configfor`) VALUES 
