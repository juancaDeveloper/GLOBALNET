...
class JSJobsModelJobsharing extends JSModel {
    ...
    function serverTask($jsondata, $fortask) {
        ...
        $sitepath = 'http://192.168.0.11/2015/jobsharing/';
        switch ($fortask) {
            ...
            case "storejob";
                ...
                $return_value = $this->performTaskJobSharingService($encoded_server_json_data_array, $url);
                break;
            case "storeapproverejectgoldfeaturedjob";
                $url = $sitepath . 'index.php?r=Jobs/storeapproverejectgoldfeaturedjob';
                $return_value = $this->performTaskJobSharingService($encoded_server_json_data_array, $url);
                break;
            case "jobapprove";
    ...
    function storeGoldFeaturedJobSharing($data) {
        if (!empty($data)) {
            $fortask = "storeapproverejectgoldfeaturedjob";
            $server_json_data_array = json_encode($data);
            $return_server_value = $this->serverTask($server_json_data_array, $fortask);
            return json_decode($return_server_value, true);
        }
    }
