...
class JSJobsControllerJsjobs extends JSController {
    ...
    function edit() {
        ...
        elseif (( $cur_layout == 'featuredresumes') || ($cur_layout == 'featuredresumesqueue')) {
            ...
            if ($c_id == '') {
                ...
                JRequest::setVar('layout', 'formfeaturedresume');
            ...
            if ($c_id == '') {
                ...
                JRequest::setVar('layout', 'formgoldresume');
        }
        $this->display();
    }
    ...
    function cancel() {
        ...
        elseif ($cur_layout == 'goldresumes')
            $this->setRedirect('index.php?option=com_jsjobs&c=resume&view=resume&layout=goldresumes');
        elseif ($cur_layout == 'goldresumesqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=resume&view=resume&layout=goldresumesqueue');
        elseif ($cur_layout == 'featuredresumes')
            $this->setRedirect('index.php?option=com_jsjobs&c=resume&view=resume&layout=featuredresumes');
        elseif ($cur_layout == 'featuredresumesqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=resume&view=resume&layout=featuredresumesqueue');
        elseif ($cur_layout == 'goldjobs')
            $this->setRedirect('index.php?option=com_jsjobs&c=job&view=job&layout=goldjobs');
        elseif ($cur_layout == 'goldjobsqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=job&view=job&layout=goldjobsqueue');
        elseif ($cur_layout == 'goldcompanies')
            $this->setRedirect('index.php?option=com_jsjobs&c=company&view=company&layout=goldcompanies');
        elseif ($cur_layout == 'goldcompaniesqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=company&view=company&layout=goldcompaniesqueue');
        elseif ($cur_layout == 'featuredcompanies')
            $this->setRedirect('index.php?option=com_jsjobs&c=company&view=company&layout=featuredcompanies');
        elseif ($cur_layout == 'featuredcompaniesqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=company&view=company&layout=featuredcompaniesqueue');
        elseif ($cur_layout == 'departmentsqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=&view=&layout=departmentsqueue');
        ...
        elseif ($cur_layout == 'featuredjobs')
            $this->setRedirect('index.php?option=com_jsjobs&c=job&view=job&layout=featuredjobs');
        elseif ($cur_layout == 'featuredjobsqueue')
            $this->setRedirect('index.php?option=com_jsjobs&c=job&view=job&layout=featuredjobsqueue');
        ...
        elseif ($cur_layout == 'view_resume') {
            ...
            elseif ($folderid)
                $this->setRedirect('index.php?option=com_jsjobs&c=folderresume&view=folderresume&layout=folder_resumes&fd=' . $folderid);
            else
        ...
        elseif ($cur_layout == 'formmessage') {
            ...
            $this->setRedirect('index.php?option=com_jsjobs&c=jobalert&view=jobalert&layout=jobalert');
        }
    }
