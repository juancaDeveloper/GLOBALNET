    ...
    function startSynchronizeProcess($auth_key) {
        ...
        if ($auth_key != "") {
            ...
            if ($return_value != "") {
                ...
                //num 22
                $message_sync = "";
                echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Synchronize Resume Rating') . '...");</script>', 50120);
                flush();
                ob_flush();
                ...
                $syn_resume_resumerating_value = $syn_resume_resumerating['return_server_value_resumerating'];

                if ($syn_resume_resumerating_value == true) {
                    $message_sync.=JText::_('Resume Rating Synchronize Successfully') . '<br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"73%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Resume Rating Synchronize Successfully') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("73%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_green").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                } elseif ($syn_resume_resumerating_value == false) {
                    $message_sync.='<span style="color:red;">' . JText::_('Error:resume Rating Synchronization') . '</span><br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"73%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Error:resume Rating Synchronization') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("73%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_red").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                ...
                //num 23
                $message_sync = "";
                echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Synchronize Folders') . '...");</script>', 50120);
                flush();
                ob_flush();
                ...
                $syn_job_folders_value = $syn_job_folders['return_server_value_folders'];

                if ($syn_job_folders_value == true) {
                    $message_sync.=JText::_('Folders Synchronize Successfully') . '<br/>';
                    if (isset($syn_job_folders['rejected_client_folders']) AND $syn_job_folders['rejected_client_folders'] !== "")
                        $message_sync.= JText::_('Following Folders Are Rejected Due To Improper Name') . $syn_job_folders['rejected_client_folders'] . "<br/>";
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"76%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Folders Synchronize Successfully') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("76%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_green").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                }
                elseif ($syn_job_folders_value == false) {
                    $message_sync.='<span style="color:red;">' . JText::_('Error:folders Synchronization') . '</span><br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"76%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Error:folders Synchronization') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("76%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_red").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                ...
                //num 24
                $message_sync = "";
                echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Synchronize Folder Resumes') . '...");</script>', 50120);
                flush();
                ob_flush();
                ...
                $syn_job_folderresumes_value = $syn_job_folderresumes['return_server_value_folderresumes'];

                if ($syn_job_folderresumes_value == true) {
                    $message_sync.=JText::_('Folder Resume Synchronize Successfully') . '<br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"80%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Folder Resume Synchronize Successfully') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("80%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_green").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                } elseif ($syn_job_folderresumes_value == false) {
                    $message_sync.='<span style="color:red;">' . JText::_('Error:folder Resume Synchronization') .' '. '</span><br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"80%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Error:folder Resume Synchronization') . ' ...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("80%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_red").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                ...
                //num 25
                $message_sync = "";
                echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Synchronize Messages') . '...");</script>', 50120);
                flush();
                ob_flush();
                ...
                $syn_job_messages_value = $syn_job_messages['return_server_value_messages'];

                if ($syn_job_messages_value == true) {
                    $message_sync.=JText::_('Messages Synchronize Successfully') . '<br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"90%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Messages Synchronize Successfully') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("90%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_green").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                } elseif ($syn_job_messages_value == false) {
                    $message_sync.='<span style="color:red;">' . JText::_('Error:messages Synchronization') . '</span><br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"90%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Error:messages Synchronization') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("90%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_red").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                ...
                //num 26
                $message_sync = "";
                echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Synchronize Job Alert Settings') . '...");</script>', 50120);
                flush();
                ob_flush();
                ...
                $syn_job_alert_value = $syn_job_alert['return_server_value_jobalertsetting'];
                if ($syn_job_alert == true) {
                    $message_sync.=JText::_('Job Alert Synchronize Successfully') . '<br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"99.9%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Job Alert Synchronize Successfully') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("100%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_green").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
                } elseif ($syn_job_alert == false) {
                    $message_sync.='<span style="color:red;">' . JText::_('Error: Job Alert Synchronization') . '</span><br/>';
                    echo str_pad('<script type="text/javascript">jQuery("span#progress_bar span").animate({"width":"99.9%"},"fast");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#process_msg_changeable").html("' . JText::_('Error: Job Alert Synchronization') . '...");</script>', 50120);
                    echo str_pad('<script type="text/javascript">jQuery("span#progress").html("100%");</script>', 50120);
                    echo str_pad('<script type="text/javascript">var span = jQuery("<span>").attr("class","sync_red").html("' . $message_sync . '");jQuery("div#text_changeable").append(span);</script>', 50120);
                    flush();
                    ob_flush();
