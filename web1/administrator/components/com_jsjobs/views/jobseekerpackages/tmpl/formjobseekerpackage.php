...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        ...
        <div class="js-form-area">
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="goldresume"><?php echo JText::_('Gold Resume'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="goldresume" id="goldresume" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->goldresume; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="goldresumeexpireindays"><?php echo JText::_('Gold Resume Expire In Days'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="goldresumeexpireindays" id="goldresumeexpireindays" size="40" maxlength="6" value="<?php if (isset($this->package)) echo $this->package->goldresumeexpireindays; ?>" /></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="featuredresume"><?php echo JText::_('Featured Resume'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="featuredresume" id="featuredresume" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->featuredresume; ?>" /><?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="freaturedresumeexpireindays"><?php echo JText::_('Featured Resume Expire In Days'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="freaturedresumeexpireindays" id="freaturedresumeexpireindays" size="40" maxlength="6" value="<?php if (isset($this->package)) echo $this->package->freaturedresumeexpireindays; ?>" /></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="jobalertsetting"><?php echo JText::_('Job Alert Setting'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['jobalertsetting']; ?></div>
                </div>
