...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=jsjobs&view=jsjobs&layout=reports"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a><span id="heading-text"><?php echo JText::_('Employer Reports'); ?></span></div>
    <div id="charts">
    ...
    <div id="admin-employer-report">
        <div class="count2">
            <div class="js-col-md-3 js-col-lg-3 js-col-xs-12 jsjobs- box-outer">
                <div class="box">
                    ...
                    <div class="text">
                        <div class="bold-text1"><?php echo $this->employerreports['totaljobs']; ?></div>
            ...
            <div class="js-col-md-3 js-col-lg-3 js-col-xs-12 jsjobs- box-outer">
                <div class="box">
                    ...
                    <div class="text">
                        <div class="bold-text2"><?php echo $this->employerreports['totalappliedresume']; ?></div>
            ...
            <div class="js-col-md-3 js-col-lg-3 js-col-xs-12 jsjobs- box-outer">
                <div class="box">
                    ...
                    <div class="text">
                        <div class="bold-text3"><?php echo $this->employerreports['totalgoldjob']; ?></div>
            ...
            <div class="js-col-md-3 js-col-lg-3 js-col-xs-12 jsjobs- box-outer">
                <div class="box">
                    ...
                    <div class="text">
                        <div class="bold-text4"><?php echo $this->employerreports['totalfeaturedjob']; ?></div>
        ...
        <div class="charthalf">
            <span class="title two">
                <?php echo JText::_('Jobs By Cities'); ?>
            </span>
            <div id="bar1"></div>
        </div>        
        <div class="charthalf">
            <span class="title three">
                <?php echo JText::_('Jobs By Types'); ?>
            </span>
            <div id="bar2"></div>
        </div>        
        <div class="charthalf">
            <span class="title four">
                <?php echo JText::_('Jobs By Companies'); ?>
            </span>
            <div id="pie2"></div>
        </div>        
    </div>
...
<script type="text/javascript">
    ...
    function drawChartTop() {
        ...
        data.addRows([
            <?php echo $this->employerreports['line_chart_json_array']; ?>
        ]);        
    ...
    function drawChartCat() {
        var piedata = google.visualization.arrayToDataTable([
              ['<?php echo JText::_('Categories'); ?>', '<?php echo JText::_('Jobs'); ?>'],
              <?php echo $this->employerreports['pie1']; ?>
        ]);
    ...
    function drawChartBar1(){
        var data = google.visualization.arrayToDataTable([
                    ['<?php echo JText::_('Job By City'); ?>', '<?php echo JText::_('Jobs'); ?>', { role: 'style' }, { role: 'annotation' } ],
                    <?php echo $this->employerreports['bar1']; ?>
                    ]);
    ...
    function drawChartpie2() {
        var piedata = google.visualization.arrayToDataTable([
              ['<?php echo JText::_('Jobs By Company'); ?>', '<?php echo JText::_('Jobs'); ?>'],
              <?php echo $this->employerreports['pie2']; ?>
        ]);
    ...
    function drawChartBar2(){
        var data = google.visualization.arrayToDataTable([
                    ['<?php echo JText::_('Job By Type'); ?>', '<?php echo JText::_('Jobs'); ?>', { role: 'style' }, { role: 'annotation' } ],
                    <?php echo $this->employerreports['bar2']; ?>
                    ]);
        var view = new google.visualization.DataView(data);
        view.setColumns([0, 1,
                           { calc: "stringify",
