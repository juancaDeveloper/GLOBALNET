...
class JSJobsViewJsjobs extends JSView {
    ...
    function display($tpl = null) {
        ...
        } elseif ($layoutName == 'reports') {
            JToolBarHelper::title(JText::_('Reports'));        
        } elseif ($layoutName == 'translation') {
            JToolBarHelper::title(JText::_('Translations'));
        } elseif ($layoutName == 'overallreports') {
            JToolBarHelper::title(JText::_('Overall Reports'));
            $result = $this->getJSModel('jsjobs')->getOverallReports();
            $this->assignRef('overall', $result);
        } elseif ($layoutName == 'employerreports') {
            JToolBarHelper::title(JText::_('Employer Reports'));
            $result = $this->getJSModel('jsjobs')->getEmployerReports();
            $this->assignRef('employerreports', $result);
        } elseif ($layoutName == 'jobseekerreports') {
            JToolBarHelper::title(JText::_('Job Seeker Reports'));
            $result = $this->getJSModel('jsjobs')->getJobseekerReports();
            $this->assignRef('jobseekerreports', $result);
