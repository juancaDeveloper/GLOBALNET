                ...
                <table class="adminlist" cellpadding="1" border="0" id="js-table">
                    <thead>
                        <tr>
                            ...
                            <th width="5%" class="center bold"><span class="blackcolor"><?php echo JText::_('Social Published'); ?> </span></th>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                            ...
                            $socialpubimg = $row->issocialpublished ? 'tick1.png' : 'cross.png';
                            $socialalt = $row->issocialpublished ? JText::_('Published') : JText::_('Unpublished');
                            ...
                            <tr class="<?php echo "row$k"; ?>">
                                ...
                                if ($sec == 'section_') {
                                    ...
                                    <td align="center" colspan="1">
                                        <a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i; ?>', 'fieldordering.<?php echo $socialpubtask; ?>')">
                                            <img src="components/com_jsjobs/include/images/<?php echo $socialpubimg; ?>" width="16" height="16" border="0" alt="<?php echo $socialalt; ?>" /></a>
                                    </td>
                                    <td colspan="3"></td>
                                <?php } else { ?>
