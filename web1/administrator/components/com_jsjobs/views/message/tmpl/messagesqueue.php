...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=jsjobs&view=jsjobs&layout=controlpanel"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a><span id="heading-text"><?php echo JText::_('Messages Queue'); ?></span></div>          
      <form action="index.php" method="post" name="adminForm" id="adminForm">
                       <div id="jsjobs_filter_wrapper_messages">
                        ...
                        <div id="jsjobs-filter-main-new">
                            ...
                            <span class="default-hidden"><input type="text" name="message_appname" id="message_appname" placeholder="<?php echo JText::_('Resume Title'); ?>" value="<?php if (isset($this->lists['appname'])) echo $this->lists['appname']; ?>" class="inputbox"  /></span>
                      ...
                      <div id="jsjobs-message-wrapper" class="js-col-xs-12 js-col-md-12">
                        <div id="message-header" class="js-col-xs-12 js-col-md-12">
                            <div id="message-head-content" class="js-col-xs-12 js-col-md-11">  
                                  ...
                                  <span class="js-col-xs-12 js-col-xs-6 message-title mesg-bold" ><span class="mesg-title-text"><?php echo JText::_('Subject').' :'; ?></span>&nbsp;<a href="<?php echo $link; ?>" ><?php echo substr(filter_var($row->message, FILTER_SANITIZE_STRING), 0, 20) ; ?></a></span>
                                  <span class="js-col-xs-12 js-col-xs-6 message-title  mesg-bold" ></span>
                              </div>
                              <div id="mesg-corner" class="js-col-xs-12 js-col-md-1" >
                                  <?php if($row->status == 0){?>
                                    <span class="mesg-right-corner"><img src="components/com_jsjobs/include/images/approved-corner.png" alt="app"><span class="listheadrightcorner-green"><?php echo JText::_('Pending'); ?></span></span>
                                    <?php }else{ ?>
                          ...
                          <div id="message-body" class="js-col-xs-12 js-col-md-12">
                              <span class="js-col-xs-12 js-col-md-12 mesg-color" id="rtitle"><span class="mesg-title-text"><?php echo JText::_('Resume Title').' :'; ?>&nbsp; </span><?php echo $row->application_title; ?></span>
                              <span class="js-col-xs-12 js-col-md-4 paddingclass mesg-color"><span class="mesg-title-text"><?php echo JText::_('Employer Name').' :'; ?>&nbsp;</span><?php echo $row->employername; ?></span>
                              <span class="js-col-xs-12 js-col-md-4 paddingclass mesg-color"><span class="mesg-title-text"><?php echo JText::_('Company').' :'; ?>&nbsp;</span><?php echo $row->companyname; ?></span>
                              <span class="js-col-xs-12 js-col-md-4 paddingclass mesg-color"><span class="mesg-title-text"><?php echo JText::_('Job Title').' :'; ?>&nbsp;</span><?php echo $row->jobtitle; ?></span>
                          </div>
                          <div id="message-footer" class="js-col-xs-12 js-col-md-12">
                              ...
                              <span class="js-col-xs-12 js-col-md-4 buttons-message">
                                  ...
                                  <a class="js-bottomspan" href="index.php?option=com_jsjobs&task=message.unpublishmessages&cid[]=<?php echo $row->id;?>"><img src="components/com_jsjobs/include/images/reject-m.png" alt="fdel">&nbsp;<?php echo JText::_('Rejected');?></a>
                                  <a class="js-bottomspan" href="index.php?option=com_jsjobs&task=message.publishmessages&cid[]=<?php echo $row->id;?>"><img src="components/com_jsjobs/include/images/approve-s.png" alt="edit">&nbsp;<?php echo JText::_('Approve');?></a>
                              </span> 
                          </div>
                        </div>
                           <?php
       ...
       <?php }else{ JSJOBSlayout::getNoRecordFound(); } ?>
                ...
                <input type="hidden" name="layout" value="messagesqueue" />
            </form>
   </div>    
</div>
