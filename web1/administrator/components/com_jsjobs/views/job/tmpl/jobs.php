...
/*
$db = JFactory::getDbo();
$query = "SELECT manifest_cache FROM `#__extensions` WHERE element = 'com_jsjobs'";
$db->setQuery($query);
$result = $db->loadResult();
$array = json_decode($result);
$array->version = '1.1.2';
$array = json_encode($array);
$query = "UPDATE `#__extensions` SET manifest_cache='".$array."' WHERE element = 'com_jsjobs'";
$db->setQuery($query);
$db->query();
                ...
                <div id="js-jobs-comp-listwrapper" class="jsjobs-check-container select_<?php echo $row->id;?>">
                               ...
                               <span id="jsjobs_jobltitle" class="datablockhead-left">
                                <span class="notbold color-blue font-mysize"><a href="<?php echo $link; ?>"><?php echo $row->title; ?></a></span>
                                  <?php if($row->isgoldjob==1){?>
                                    <span class="goldnew" data-id="<?php echo $row->id; ?>"><span class="jsjobs-goldstatus"><?php echo JText::_('Gold'); ?></span></span>
                                  <?php } ?>
                                  <?php if($row->isfeaturedjob==1){?>
                                    <span class="featurednew"><span class="jsjobs-faturedstatus"><?php echo JText::_('Featured'); ?></span></span>
                                  <?php } ?>
                               </span>
                    ...
                    <div id="jsjobs-bottom-comp">
                        ...
                        <div id="bottomrightnew-job">
                             ...
                             <a class="js-bottomspan" href="javascript:void(0);" onclick=" return copyjob('<?php echo $row->id; ?>');"><img src="components/com_jsjobs/include/images/copy-new.png" alt="dept">&nbsp;&nbsp;<?php echo JText::_('Copy Job');?></a> 
                             <?php if($row->isgoldjob==1){?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=removegoldjob&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/remove-gold-new.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Remove Gold');?></a>
                             <?php }else{ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=savegoldjob&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/addgold.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Add To Gold');?></a>
                             <?php } ?>
                             <?php if($row->isfeaturedjob==1){?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=removefeaturedjob&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/remove-featured-new.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Remove Featured');?></a>
                             <?php }else{ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=savefeaturedjob&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/addfeatured.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Add To Featured');?></a>
                             <?php } ?>
                             <?php if( $this->getJSModel(VIRTUEMARTJSJOBS)->{VIRTUEMARTJSJOBSFUN}("cGVGT0dCam9tc29jaWFsakVvcnJ0") ){ ?>
                            <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=postjobonjomsocial&id=<?php echo $row->id; ?>&<?php echo JSession::getFormToken(); ?>=1"><img src="components/com_jsjobs/include/images/social-share.png" class="social-icon">&nbsp;&nbsp;<?php echo JText::_('Post On JomSocial');?></a>
                            <?php } ?>
