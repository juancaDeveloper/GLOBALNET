        ...
        <?php if(!empty($this->items)){ ?>
                ...
                <div id="js-jobs-comp-listwrapper" class="jsjobs-check-container select_<?php echo $row->id;?>">
                    <div id="jsjobs-top-comp-left">
                       ...
                       ?>
                        <a class="jsjobs-leftimg" href="<?php echo $comp_path;?>"><img class="myfilelogoimg" src="<?php echo $path;?>"/></a>
                    </div>
                            ...
                            <div id="innerheaderlefti">
                               <span id="jsjobs_jobltitle" class="datablockhead-left"><span class="notbold color-blue font-mysize"><a href="<?php echo $link; ?>"><?php echo $row->title; ?></a></span>
                                  <?php if($row->isgoldjob==1){?>
                                    <span class="goldnew" data-id="<?php echo $row->id; ?>"><span class="jsjobs-goldstatus"><?php echo JText::_('Gold'); ?></span><span class="goldnew-onhover" id="gold<?php echo $row->id; ?>" style="display:none"><?php echo JText::_("Expired On: ".$row->id); ?><img src="components/com_jsjobs/include/images/bottom-tool-tip.png" alt="downhover-part"></span></span>
                                  <?php } ?>
                                  <?php if($row->isfeaturedjob==1){?>
                                    <span class="featurednew"><span class="jsjobs-faturedstatus"><?php echo JText::_('Featured'); ?></span><span class="featurednew-onhover" style="display:none"><?php echo JText::_("Expired On: ".$row->id); ?><img src="components/com_jsjobs/include/images/bottom-tool-tip.png" alt="downhover-part"></span></span>
                                  <?php } ?>
                               </span>
                            </div>
                        ...
                        <div id="bottomrightnew"> <?php
                          ...
                          if($total==1){
                            if(isset($arr['self'])){
                              ...
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=goldjobapprove&id='.$row->id.'"><img src="components/com_jsjobs/include/images/hired-new.png">  '.JText::_('Approve').'</a>';
                            }elseif(isset($arr['feature'])){
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=featuredjobapprove&id='.$row->id.'"><img src="components/com_jsjobs/include/images/hired-new.png">  '.JText::_('Approve').'</a>';
                            }
                          }else{ ?>
                            <div class="js-bottomspan jobsqueue-approvalqueue" onmouseout="hideThis(this);" onmouseover="approveActionPopup('<?php echo $row->id; ?>');"><img src="components/com_jsjobs/include/images/hired-new.png">&nbsp;&nbsp;<?php echo JText::_('Approve');?>
                              <div id="jsjobs-queue-actionsbtn" class="jobsqueueapprove_<?php echo $row->id;?>">
                                <?php
                                  ...
                                  if(isset($arr['gold'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=job&task=goldjobapprove&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addgold.png">'.JText::_("Gold Approve").'</a>';
                                  }
                                  if(isset($arr['feature'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=job&task=featuredjobapprove&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addfeatured.png">'.JText::_("Feature Approve").'</a>';
                                  }
                                  echo '<a id="jsjobs-act-row-all" class="jsjobs-act-row-all" href="index.php?option=com_jsjobs&c=job&task=allapprove&alltype='.$objid.'&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/select-all.png">'.JText::_("All Approve").'</a>';
                                ?>
                              </div>
                            </div>
                          <?php
                          ...
                          if($total==1){
                            if(isset($arr['self'])){
                              ...
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=goldjobreject&id='.$row->id.'"><img src="components/com_jsjobs/include/images/reject-s.png">  '.JText::_('Reject').'</a>';
                            }elseif(isset($arr['feature'])){
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=job&task=featuredjobreject&id='.$row->id.'"><img src="components/com_jsjobs/include/images/reject-s.png">  '.JText::_('Reject').'</a>';
                            }
                          }else{ ?>
                            <div class="js-bottomspan jobsqueue-approvalqueue" onmouseout="hideThis(this);" onmouseover="rejectActionPopup('<?php echo $row->id; ?>');"><img src="components/com_jsjobs/include/images/reject-s.png">&nbsp;&nbsp;<?php echo JText::_('Reject');?>
                              <div id="jsjobs-queue-actionsbtn" class="jobsqueuereject_<?php echo $row->id;?>">
                                <?php
                                  ...
                                  if(isset($arr['gold'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=job&task=goldjobreject&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addgold.png">'.JText::_("Gold Reject").'</a>';
                                  }
                                  if(isset($arr['feature'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=job&task=featuredjobreject&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addfeatured.png">'.JText::_("Feature Reject").'</a>';
                                  }
                                  echo '<a id="jsjobs-act-row-all" class="jsjobs-act-row-all" href="index.php?option=com_jsjobs&c=job&task=allreject&alltype='.$objid.'&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/select-all.png">'.JText::_("All Reject").'</a>';
                                ?>
                              </div>
                            </div>
                          <?php
