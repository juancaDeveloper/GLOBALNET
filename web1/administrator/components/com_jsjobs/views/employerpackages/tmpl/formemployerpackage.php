    ...
    <div id="jsjobs-content">
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm" >
            ...
            <input type="hidden" name="check" value="post"/>
                ...
                <?php
                if( JComponentHelper::isEnabled('com_virtuemart') && JPluginHelper::isEnabled('vmextended','jsjobs') ){
                    JPluginHelper::importPlugin('vmextended');
                    $dispatcher = JEventDispatcher::getInstance();
                    $dispatcher->trigger('JSjobsOnPackageFormRender',array($this->package));
                }
                ?>
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="goldcompanies"><?php echo JText::_('Gold Companies'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="goldcompanies" id="goldcompanies" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->goldcompanies; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="goldcompaniesexpireindays"><?php echo JText::_('Gold Companies Expire In Days'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="goldcompaniesexpireindays" id="goldcompaniesexpireindays" size="40" maxlength="6" value="<?php if (isset($this->package)) echo $this->package->goldcompaniesexpireindays; ?>" /></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="featuredcompaines"><?php echo JText::_('Featured Companies'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="featuredcompaines" id="featuredcompaines" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->featuredcompaines; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="featuredcompaniesexpireindays"><?php echo JText::_('Featured Companies Expire In Days'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="featuredcompaniesexpireindays" id="featuredcompaniesexpireindays" size="40" maxlength="6" value="<?php if (isset($this->package)) echo $this->package->featuredcompaniesexpireindays; ?>" /></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="goldjobs"><?php echo JText::_('Gold Jobs'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="goldjobs" id="goldjobs" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->goldjobs; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="featuredjobs"><?php echo JText::_('Featured Jobs'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="featuredjobs" id="featuredjobs" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->featuredjobs; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="folders"><?php echo JText::_('Folders Allow'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="folders" id="folders" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->folders; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="messageallow"><?php echo JText::_('Messages Allow'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['messages']; ?></div>
                </div>
