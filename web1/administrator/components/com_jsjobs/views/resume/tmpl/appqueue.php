                            ...
                            <div id="innerheaderlefti">
                               ...
                               <span id="jsjobs-resumetitle" class="datablockhead-left">
                                <span class="notbold color-blue font-mysize"><a href="<?php echo $link; ?>"><?php echo $row->application_title; ?></a></span>
                                  <?php if($row->isgoldresume==1 AND date('Y-m-d',strtotime($row->endgolddate)) > date('Y-m-d')){?>
                                  ...
                                  <?php } ?>
                                  <?php if($row->isfeaturedresume==1 AND date('Y-m-d',strtotime($row->endfeaturedate)) > date('Y-m-d')){?>
                                    <span class="featurednew"><span class="jsjobs-faturedstatus"><?php echo JText::_('Featured'); ?></span><span class="featurednew-onhover" style="display:none"><?php echo JText::_("Expiry Date").': '.JHTML::_('date',strtotime($row->endfeaturedate),$this->config['date_format']);?><img src="components/com_jsjobs/include/images/bottom-tool-tip.png" alt="downhover-part"></span></span>
                                  <?php } ?>
                                  </span>
                            </div>
                        ...
                        <div id="bottomrightnew"> <?php
                          ...
                          if($total==1){
                            if(isset($arr['self'])){
                              ...
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=goldresumeapprove&id='.$row->id.'"><img src="components/com_jsjobs/include/images/hired-new.png">  '.JText::_('Approve').'</a>';
                            }elseif(isset($arr['feature'])){
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=featuredresumeapprove&id='.$row->id.'"><img src="components/com_jsjobs/include/images/hired-new.png">  '.JText::_('Approve').'</a>';
                            }
                          }else{ ?>
                            <div class="js-bottomspan jobsqueue-approvalqueue" onmouseout="hideThis(this);" onmouseover="approveActionPopup('<?php echo $row->id; ?>');"><img src="components/com_jsjobs/include/images/hired-new.png">&nbsp;&nbsp;<?php echo JText::_('Approve');?>
                              <div id="jsjobs-queue-actionsbtn" class="jobsqueueapprove_<?php echo $row->id;?>">
                                <?php
                                  ...
                                  if(isset($arr['gold'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=resume&task=goldresumeapprove&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addgold.png">'.JText::_("Gold Approve").'</a>';
                                  }
                                  if(isset($arr['feature'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=resume&task=featuredresumeapprove&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addfeatured.png">'.JText::_("Feature Approve").'</a>';
                                  }
                                  echo '<a id="jsjobs-act-row-all" class="jsjobs-act-row-all" href="index.php?option=com_jsjobs&c=resume&task=allapprove&alltype='.$objid.'&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/select-all.png">'.JText::_("All Approve").'</a>';
                                ?>
                              </div>
                            </div>
                          <?php
                          ...
                          if($total==1){
                            if(isset($arr['self'])){
                              ...
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=goldresumereject&id='.$row->id.'"><img src="components/com_jsjobs/include/images/reject-s.png">  '.JText::_('Reject').'</a>';
                            }elseif(isset($arr['feature'])){
                              echo '<a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=featuredresumereject&id='.$row->id.'"><img src="components/com_jsjobs/include/images/reject-s.png">  '.JText::_('Reject').'</a>';
                            }
                          }else{ ?>
                            <div class="js-bottomspan jobsqueue-approvalqueue" onmouseout="hideThis(this);" onmouseover="rejectActionPopup('<?php echo $row->id; ?>');"><img src="components/com_jsjobs/include/images/reject-s.png">&nbsp;&nbsp;<?php echo JText::_('Reject');?>
                              <div id="jsjobs-queue-actionsbtn" class="jobsqueuereject_<?php echo $row->id;?>">
                                <?php
                                  ...
                                  if(isset($arr['gold'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=resume&task=goldresumereject&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addgold.png">'.JText::_("Gold Reject").'</a>';
                                  }
                                  if(isset($arr['feature'])){
                                    echo '<a id="jsjobs-act-row" class="jsjobs-act-row" href="index.php?option=com_jsjobs&c=resume&task=featuredresumereject&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/addfeatured.png">'.JText::_("Feature Reject").'</a>';
                                  }
                                  echo '<a id="jsjobs-act-row-all" class="jsjobs-act-row-all" href="index.php?option=com_jsjobs&c=resume&task=allreject&alltype='.$objid.'&id='.$row->id.'"><img class="jobs-action-image" src="components/com_jsjobs/include/images/select-all.png">'.JText::_("All Reject").'</a>';
                                ?>
                              </div>
                            </div>
                          <?php
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery("#checkallbox").hover(function(){            
            jQuery(this).find("span.selectallbox-onhover").show();
        },function() {
            jQuery(this).find('.selectallbox-onhover').fadeOut("slow");
        });
