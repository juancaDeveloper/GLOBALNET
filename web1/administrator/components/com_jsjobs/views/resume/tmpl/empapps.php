                ...
                <div id="js-jobs-comp-listwrapper" class="jsjobs-check-container select_<?php echo $row->id;?>">
                    ...
                    <div id="jsjobs-bottom-comp">
                        ...
                        <div id="bottomrightnew-resume">
                             ...
                             <?php if($row->isgoldresume==1 AND date('Y-m-d',strtotime($row->endgolddate)) > date('Y-m-d')){?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=removegoldresume&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/remove-gold-new.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Remove Gold');?></a>
                             <?php }else{ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=savegoldresume&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/addgold.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Add To Gold');?></a>
                             <?php } ?>

                             <?php if($row->isfeaturedresume==1 AND date('Y-m-d',strtotime($row->endfeaturedate)) > date('Y-m-d')){?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=removefeaturedresume&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/remove-featured-new.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Remove Featured');?></a>
                             <?php }else{ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=savefeaturedresume&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/addfeatured.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Add To Featured');?></a>
                             <?php } ?>
                             <?php if( $this->getJSModel(VIRTUEMARTJSJOBS)->{VIRTUEMARTJSJOBSFUN}("UGF0dFlJam9tc29jaWFsS1ducDhi") ){ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=resume&task=postresumeonjomsocial&id=<?php echo $row->id; ?>&<?php echo JSession::getFormToken(); ?>=1"><img src="components/com_jsjobs/include/images/social-share.png" class="social-icon">&nbsp;&nbsp;<?php echo JText::_('Post On JomSocial');?></a>
                              <?php } ?>
