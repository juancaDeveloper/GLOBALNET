        ...
        <table class="adminlist" border="0" id="js-table">
            ...
            <tbody>
                ...
                <tr valign="top" class="">
                    ...
                    <td class="center"><a href="index.php?option=com_jsjobs&c=emailtemplate&task=<?php echo $method; ?>&emailfor=<?php echo $data->emailfor; ?>&for=3"><img src="components/com_jsjobs/include/images/<?php if($data->admin == 1) echo $img_yes; else echo $img_no; ?>" width="16" height="16" border="0" /></a></td>
                    <td class="center">-</td>
                    <td class="center"><a href="index.php?option=com_jsjobs&c=emailtemplate&task=<?php echo $method; ?>&emailfor=<?php echo $data->emailfor; ?>&for=5"><img src="components/com_jsjobs/include/images/<?php if($data->employer_visitor == 1) echo $img_yes; else echo $img_no; ?>" width="16" height="16" border="0" /></a></td>
                ...
                <tr valign="top" class="">
                    ...
                    <td class="center"><a href="index.php?option=com_jsjobs&c=emailtemplate&task=<?php echo $method; ?>&emailfor=<?php echo $data->emailfor; ?>&for=3"><img src="components/com_jsjobs/include/images/<?php if($data->admin == 1) echo $img_yes; else echo $img_no; ?>" width="16" height="16" border="0" /></a></td>
                    <td class="center"><a href="index.php?option=com_jsjobs&c=emailtemplate&task=<?php echo $method; ?>&emailfor=<?php echo $data->emailfor; ?>&for=4"><img src="components/com_jsjobs/include/images/<?php if($data->jobseeker_visitor == 1) echo $img_yes; else echo $img_no; ?>" width="16" height="16" border="0" /></a></td>
                    <td class="center">-</td>
