    ...
    */  ?>
    <div class="js-divlink">
        ...
        <div class="js-innerlink">
            ...
            <a class="js-child" href="index.php?option=com_jsjobs&c=configuration&view=configuration&layout=themes"><span class="text"><?php echo JText::_('Themes'); ?></span></a>
            <a class="js-child" href="index.php?option=com_jsjobs&c=configuration&view=configuration&layout=cronjob"><span class="text"><?php echo JText::_('Cron Job'); ?></span></a>
            <a class="js-child" href="index.php?option=com_jsjobs&c=paymentmethodconfiguration&view=paymentmethodconfiguration&layout=paymentmethodconfig"><span class="text"><?php echo JText::_('Payment Methods'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
        ...
        <div class="js-innerlink">
            ...
            <a class="js-child" href="index.php?option=com_jsjobs&c=report&view=report&layout=companiesexport"><span class="text"><?php echo JText::_('Export Companies'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
    ...
    <div class="js-divlink">
        ...
        <div class="js-innerlink">
            ...
            <a class="js-child" href="index.php?option=com_jsjobs&c=fieldordering&view=fieldordering&layout=searchfields&ff=2"><span class="text"><?php echo JText::_('Search Fields'); ?></span></a>
            <a class="js-child" href="index.php?option=com_jsjobs&c=jobalert&view=jobalert&layout=jobalert"><span class="text"><?php echo JText::_('Job Alert'); ?></span></a>
            <a class="js-child" href="index.php?option=com_jsjobs&c=report&view=report&layout=jobsexport"><span class="text"><?php echo JText::_('Export Jobs'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
        ...
        <div class="js-innerlink">
            ...
            <a class="js-child" href="index.php?option=com_jsjobs&c=fieldordering&view=fieldordering&layout=searchfields&ff=3"><span class="text"><?php echo JText::_('Search Fields'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
        <a href="index.php?option=com_jsjobs&c=premiumplugin&view=premiumplugin&layout=premiumplugins">
            <img src="components/com_jsjobs/include/images/left_menu_icons/premium_plugins.png" />
        </a>        
        <a href="#" class="js-parent <?php if($c == 'premiumplugin') echo 'lastshown'; ?>"><span class="text"><?php echo JText::_('Premium Plugins'); ?><img class="arrow" src="components/com_jsjobs/include/images/left_menu_icons/arrow1.png"/></span></a>
        <div class="js-innerlink">
            <a class="js-child" href="index.php?option=com_jsjobs&c=premiumplugin&view=premiumplugin&layout=premiumplugins"><span class="text"> <?php echo JText::_('Premium Plugins'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
    ...
    <div class="js-divlink">
        <a href="index.php?option=com_jsjobs&c=message&view=message&layout=messages">
            <img src="components/com_jsjobs/include/images/left_menu_icons/messages.png" />
        </a>
        <a href="#" class="js-parent <?php if($c == 'message') echo 'lastshown'; ?>"><span class="text"><?php echo JText::_('Messages'); ?><img class="arrow" src="components/com_jsjobs/include/images/left_menu_icons/arrow1.png"/></span></a>
        <div class="js-innerlink">
            <a class="js-child" href="index.php?option=com_jsjobs&c=message&view=message&layout=messages"><span class="text"><?php echo JText::_('Messages'); ?></span></a>
            <a class="js-child" href="index.php?option=com_jsjobs&c=message&view=message&layout=messagesqueue"><span class="text"><?php echo JText::_('Approval Queue'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
        <a href="index.php?option=com_jsjobs&c=folder&view=folder&layout=folders">
            <img src="components/com_jsjobs/include/images/left_menu_icons/folder.png" />
        </a>
        <a href="#" class="js-parent <?php if($c == 'folder') echo 'lastshown'; ?>"><span class="text"><?php echo JText::_('Folders'); ?><img class="arrow" src="components/com_jsjobs/include/images/left_menu_icons/arrow1.png"/></span></a>
        <div class="js-innerlink">
            <a class="js-child" href="index.php?option=com_jsjobs&c=folder&view=folder&layout=folders"><span class="text"><?php echo JText::_('Folders'); ?></span></a>
            <a class="js-child" href="index.php?option=com_jsjobs&c=folder&view=folder&layout=foldersqueue"><span class="text"><?php echo JText::_('Approval Queue'); ?></span></a>
        </div>
    </div>
    <div class="js-divlink">
