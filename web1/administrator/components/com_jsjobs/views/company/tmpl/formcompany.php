...
<div id="jsjobs-wrapper">
    ...
    <div style="display:none;" id="popup_main">
        <span class="popup-top"><span id="popup_title"><?php echo JText::_('Select Employer'); ?></span><img id="popup_cross" src="components/com_jsjobs/include/images/popup-close.png"></span>
        <div class="jobs-comp-employer-popupwrapper">
            <div class="search-center">
                <div class="jsjobs-searchpopupwrapper">
                    <div class="search-value">
                        <input type="text" name="name" id="filter_name" placeholder="<?php echo JText::_('Name');?>" />
                    </div>
                    <div class="search-value">
                        <input type="text" name="email" id="filter_email" placeholder="<?php echo JText::_('Email Address');?>"/>
                    </div>
                    <div class="search-value-button">
                        <div class="js-button ">
                            <input type="submit" class="submit-button" onclick="getEmployerList();" value="<?php echo JText::_('Search');?>" />
                        </div>
                        <div class="js-button">
                            <input type="submit" onclick="document.getElementById('filter_name').value = ''; document.getElementById('filter_email').value = ''; getEmployerList();" value="<?php echo JText::_('Reset');?>" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data"  >
            <div class="js-form-area">
                ...
                if(isset($this->company)){
                    $employername = ($this->company->employername != '') ? $this->company->employername : '';
                }
                ?>
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for=""><?php echo JText::_('Employer Name'); ?></label>
                    <div class="jsjobs-value"><span id="employername"><?php echo $employername; ?></span> <a onclick="getEmployerList();" href="javascript:void(0);"><?php echo JText::_('Select Employer'); ?></a></div>
                </div>
                  <?php
...
?>
                <input type="hidden" name="uid" id="uid" value="<?php if (isset($this->company)) echo $this->company->uid; ?>" />
...
<script type="text/javascript">
    ...
    function getEmployerList(user_limit = 0){
        var name = jQuery('input#filter_name').val();
        var email = jQuery('input#filter_email').val();
        jQuery.post("index.php?option=com_jsjobs&task=user.getemployerlistajax", {name: name , email, email , userlimit : user_limit }, function (data) {
            if (data) {
