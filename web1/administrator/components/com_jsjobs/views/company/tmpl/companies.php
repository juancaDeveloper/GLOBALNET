                ...
                <div id="js-jobs-comp-listwrapper" class="jsjobs-check-container select_<?php echo $row->id;?>">
                            ...
                            <div id="innerheaderlefti">
                               <span class="datablockhead-left"><span class="notbold color-blue font-mysize"><a href="<?php echo $link; ?>"><?php echo $row->name; ?></a></span>
                                  ...
                                  <?php if($row->isfeaturedcompany==1 AND date('Y-m-d',strtotime($row->endfeatureddate)) > date('Y-m-d')){?>
                                    <span class="featurednew"><span class="jsjobs-faturedstatus"><?php echo JText::_('Featured'); ?></span><span class="featurednew-onhover" style="display:none"><?php echo JText::_("Expiry Date").': '.JHTML::_('date',strtotime($row->endfeatureddate),$this->config['date_format']); ?><img src="components/com_jsjobs/include/images/bottom-tool-tip.png" alt="downhover-part"></span></span>
                                  <?php } ?>
                               </span>
                            </div>
                    ...
                    <div id="jsjobs-bottom-comp">
                        ...
                        <div id="bottomrightnew">
                             ...
                             <?php if($row->isgoldcompany==1 AND date('Y-m-d',strtotime($row->endgolddate)) > date('Y-m-d')){?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=company&task=removegoldcompany&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/remove-gold-new.png" alt="gold/featured">&nbsp;<?php echo JText::_('Remove Gold');?></a>
                             <?php }else{ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=company&task=savegoldcompany&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/addgold.png" alt="gold/featured">&nbsp;<?php echo JText::_('Add To Gold');?></a>
                             <?php } ?>
                              <?php if($row->isfeaturedcompany==1 AND date('Y-m-d',strtotime($row->endfeatureddate)) > date('Y-m-d')){?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=company&task=removefeaturedcompany&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/remove-featured-new.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Remove Featured');?></a>
                             <?php }else{ ?>
                             <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=company&task=savefeaturedcompany&id=<?php echo $row->id; ?>"><img src="components/com_jsjobs/include/images/addfeatured.png" alt="gold/featured">&nbsp;&nbsp;<?php echo JText::_('Add To Featured');?></a>
                             <?php } ?>
                            <?php if( $this->getJSModel(VIRTUEMARTJSJOBS)->{VIRTUEMARTJSJOBSFUN}("UDZiWndkam9tc29jaWFsZ3RDV3VQ") ){ ?>
                            <a class="js-bottomspan" href="index.php?option=com_jsjobs&c=company&task=postcompanyonjomsocial&id=<?php echo $row->id; ?>&<?php echo JSession::getFormToken(); ?>=1"><img src="components/com_jsjobs/include/images/social-share.png" class="social-icon">&nbsp;&nbsp;<?php echo JText::_('Post On JomSocial');?></a>
                            <?php } ?>
