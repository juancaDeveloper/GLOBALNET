    ...
    <div id="jsjobs-content">
        ...
        <form action="index.php" method="POST" name="adminForm" id="adminForm">
            <div class="js-form-area js-jobs-from-export">
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="title"><?php echo JText::_('Nationality'); ?>:</label>
                    <div class="jsjobs-value"><?php echo $this->lists['nationality']; ?> </div>
                </div>
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="title"><?php echo JText::_('Highest Education'); ?>:</label>
                    <div class="jsjobs-value"><?php echo $this->lists['highestfinisheducation']; ?> </div>
                </div>
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="title"><?php echo JText::_('Minimum Exprience'); ?>:</label>
                    <div class="jsjobs-value"><?php echo $this->lists['experiencemin']; ?> </div>
                </div>
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="title"><?php echo JText::_('Maximum Exprience'); ?>:</label>
                    <div class="jsjobs-value"><?php echo $this->lists['experiencemax']; ?> </div>
                </div>
                ...
                <input type="hidden" name="task" value="report.exportresumessdata" />
