    ...
    foreach ($fieldsordering['personal'] as $field) {
        switch ($field->field) {
            ...
            case "nationality":
                ...
                break;
            case "date_of_birth":
                addRow($field->fieldtitle, JHtml::_('date', $this->resume->date_of_birth, $this->config['date_format']), $y, $pdf, $field->published);
                break;
            case "gender":
            ...
            case "heighestfinisheducation":
                ...
                break;
            case "date_start":
                addRow($field->fieldtitle, JHtml::_('date', $this->resume->date_start, $this->config['date_format']), $y, $pdf, $field->published);
                break;
            ...
            case "driving_license":
                $value_var = $this->resume->driving_license == 0 ? JText::_('No') : JText::_('Yes') ;
        ...
        foreach ($fieldsordering['resume'] as $field) {
            switch ($field->field) {
                ...
                case "resume":
                    ...
                    $this->resume->resume = strip_tags($this->resume->resume);
                    $pdf->SetFont("DejaVu", "", 11);
                    $pdf->SetY($y);
