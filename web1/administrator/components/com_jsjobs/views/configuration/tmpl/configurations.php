...
<div id="jsjobs-wrapper">
            ...
            <input type="hidden" name="check" value="post"/>
                <div id="tabs_wrapper" class="tabs_wrapper">
                  <div class="idTabs">
                    ...
                    <a  class="linktabclass" href="#jomsocial"><?php echo JText::_('JomSocial Settings'); ?></a>
 ...
 <div id="jsjobs_left_main">
    ...
    <div id="jsjob_configuration_wrapper" >
        <label class="jobs-config-title stylelabeltop labelcolortop" for="captchause">
            <?php echo JText::_('Set Default Captcha'); ?>
        </label>
        <div class="jobs-config-value">
           <?php echo $captcha; ?>
        </div>
    ...
    <div id="jsjob_configuration_wrapper" >
        <label class="jobs-config-title stylelabeltop labelcolortop" for="message_auto_approve">
            <?php echo JText::_('Message Auto Approve'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper" >
        <label class="jobs-config-title stylelabeltop labelcolortop" for="conflict_message_auto_approve">
            <?php echo JText::_('Conflict Message Auto Approve'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="captchause">
            <?php echo JText::_('Default Company Logo'); ?>
        </label>
        <div class="jobs-config-value">
           <input type="file" name="companydefaultlogo" />
        </div>
        <div class="jobs-config-descript">
            <label class=" stylelabelbottom labelcolorbottom" for="captchause"><?php echo JURI::root().$this->config['companydefaultlogopath']; ?></label>
        </div>
    </div>
 ...
 <div id="jsjobs_left_main">
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="showgoldjobsinnewestjobs">
            <?php echo JText::_('Show Gold Jobs'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="showfeaturedjobsinnewestjobs">
            <?php echo JText::_('Show Featured Jobs'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="noofgoldjobsinlisting">
            <?php echo JText::_('Number Of Gold Jobs'); ?>
        </label>
        <div class="jobs-config-value">
 ...
 <div id="jsjobs_right_main">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="noofgoldjobsinlisting">
            <?php echo JText::_('Total Number of Jobs'); ?>
        </label>
        <div class="jobs-config-value">
             <?php echo JHTML::_('select.genericList', $yesno, 'showtotalnjobs', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['showtotalnjobs']); ?>
        </div>
        <div class="jobs-config-descript" >
            <label class=" stylelabelbottom labelcolorbottom" for="noofgoldjobsinlisting"><?php echo JText::_('Show total number of jobs in job listing'); ?>.</label>     
        </div>
    </div>
 ...
 <div id="jsjobs_left_main">
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="user_registration_captcha">
            <?php echo JText::_('Show Captcha On Registration Form'); ?>
        </label>
        <div class="jobs-config-value">
...
<div id="socialsharing">
   <div class="headtext"><?php echo JText::_('Social Links'); ?></div>
    <div class="socialconfig_block">
        ...
        if ($this->config['jobseeker_share_fb_like'] == 1)
               ...
               'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_fb_like"><?php echo JText::_('Facebook Likes'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_fb_comments'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_fb_comments"><?php echo JText::_('Facebook Comments'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_fb_share'] == 1)
               ...
               'checked="false"';
           ?> /><label class="socialconfig_label" for="jobseeker_share_fb_share"><?php echo JText::_('Facebook Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_google_like'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_google_like"><?php echo JText::_('Google Likes'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_blog_share'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_blog_share"><?php echo JText::_('Blogger'); ?></label>
        </div>
        ...
        <input type="checkbox" value="1" name="jobseeker_share_google_share" id="jobseeker_share_google_share" <?php
           if ($this->config['jobseeker_share_google_share'] == 1)
               ...
               'checked="false"';
           ?> /><label class="socialconfig_label" for="jobseeker_share_google_share"><?php echo JText::_('Google Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_friendfeed_share'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_friendfeed_share"><?php echo JText::_('Friend Feed Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_linkedin_share'] == 1)
            ...
            'checked="false"';
               ?> /><label class="socialconfig_label" for="jobseeker_share_linkedin_share"><?php echo JText::_('Linked-in Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_digg_share'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_digg_share"><?php echo JText::_('Digg Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_twiiter_share'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_twiiter_share"><?php echo JText::_('Twitter Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_myspace_share'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_myspace_share"><?php echo JText::_('Myspace Share'); ?></label>
        </div>
        ...
        if ($this->config['jobseeker_share_yahoo_share'] == 1)
            ...
            'checked="false"';
        ?> /><label class="socialconfig_label" for="jobseeker_share_yahoo_share"><?php echo JText::_('Yahoo Share'); ?></label>
        </div>
 ...
 <div id="rss_job_set">
  ...
  <div class="headtext"><?php echo JText::_('RSS Jobs Settings'); ?></div>
 <div id="jsjobs_left_main">
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="job_rss">
            <?php echo JText::_('Jobs RSS'); ?>
        </label>
        <div class="jobs-config-value">
            <?php
 ...
 <div id="jsjobs_right_main">
    ...
    <div id="jsjob_configuration_wrapper" >
        ...
        <div class="jobs-config-descript">
            <label class=" stylelabelbottom labelcolorbottom" for="rss_job_webmaster"><?php echo JText::_('Leave blank if not show webmaster email address used for technical issue'); ?></label>     
        </div>
    </div>
  </div><!-- right closed -->
   
  <div class="headtext"><?php echo JText::_('Job Block'); ?></div>
 <div id="jsjobs_left_main">
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="rss_job_categories">
            <?php echo JText::_('Show With Categories'); ?>
        </label>
        <div class="jobs-config-value">
 ...
 <div id="jsjobs_right_main">
    <div id="jsjob_configuration_wrapper" >
        <label class="jobs-config-title stylelabeltop labelcolortop" for="rss_job_image">
            <?php echo JText::_('Company Image'); ?>
        </label>
        <div class="jobs-config-value">
 ...
 <div id="rss_resume_set">
  ...
  <div class="headtext"><?php echo JText::_('RSS Resume Settings'); ?></div>
 <div id="jsjobs_left_main">
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="resume_rss">
            <?php echo JText::_('Resume RSS'); ?>
        </label>
        <div class="jobs-config-value">
            <?php
 ...
 <div id="jsjobs_right_main">
  ...
  <div class="headtext"><?php echo JText::_('Resume Block'); ?></div>
 <div id="jsjobs_left_main">
    <div id="jsjob_configuration_wrapper">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="rss_resume_file">
            <?php echo JText::_('Show Resume File'); ?>
        </label>
        <div class="jobs-config-value">
 ...
 <div class="headtext"><?php echo JText::_('Google Adsense Settings'); ?></div>
 <div id="jsjobs_left_main">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="googleadsenseclient">
            <?php echo JText::_('Google Adsense Client Id'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="googleadsenseslot">
            <?php echo JText::_('Google Adsense Slot Id'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="googleadsensecustomcss">
            <?php echo JText::_('Google Ads Custom Css'); ?>
        </label>
        <div class="jobs-config-value">
 ...
 <div id="jsjobs_right_main">
    ...
    <div id="jsjob_configuration_wrapper">
        <label class="jobs-config-title stylelabeltop labelcolortop" for="googleadsenseshowafter">
            <?php echo JText::_('Google Ads Show After Number Of Jobs'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper" >
        <label class="jobs-config-title stylelabeltop labelcolortop" for="googleadsensewidth">
            <?php echo JText::_('Google Ads Width'); ?>
        </label>
        <div class="jobs-config-value">
    ...
    <div id="jsjob_configuration_wrapper" >
        <label class="jobs-config-title stylelabeltop labelcolortop" for="googleadsenseheight">
            <?php echo JText::_('Google Ads Height'); ?>
        </label>
        <div class="jobs-config-value">
 ...
 <!--jomSocial open-->
 <div id="jomsocial">
    <div class="headtext"><?php echo JText::_('JomSocial'); ?></div>
    <div id="jsjobs_left_main">
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="isenabled_jomsocial">
                <?php echo JText::_('Enable JomSocial Integration'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'isenabled_jomsocial', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['isenabled_jomsocial']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_postcompany"><?php echo JText::_('Only enable if jomSocial is installed'); ?></label>
            </div>
        </div>
    </div>
    <div class="headtext"><?php echo JText::_('JomSocial Post'); ?></div>
    <div id="jsjobs_left_main">
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="jomsocial_postcompany">
                <?php echo JText::_('Post New Company'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'jomsocial_postcompany', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['jomsocial_postcompany']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_postcompany"><?php echo JText::_('Create post/activity on jomsocial account when new company is created'); ?></label>
            </div>
        </div>
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="jomsocial_postjob">
                <?php echo JText::_('Post New Job'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'jomsocial_postjob', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['jomsocial_postjob']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_postjob"><?php echo JText::_('Create post/activity on jomsocial account when new job is created'); ?></label>
            </div>
        </div>
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="jomsocial_postresume">
                <?php echo JText::_('Post New Resume'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'jomsocial_postresume', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['jomsocial_postresume']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_postresume"><?php echo JText::_('Create post/activity on jomsocial account when new resume is created'); ?></label>
            </div>
        </div>
    </div>
    <div id="jsjobs_right_main">
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="jomsocial_allowpostcompany">
                <?php echo JText::_('Allow Post Company'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'jomsocial_allowpostcompany', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['jomsocial_allowpostcompany']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_allowpostcompany"><?php echo JText::_('Allow employer to post company on jomsocial from My Companies layout'); ?></label>
            </div>
        </div>
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="jomsocial_allowpostjob">
                <?php echo JText::_('Allow Post Job'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'jomsocial_allowpostjob', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['jomsocial_allowpostjob']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_allowpostjob"><?php echo JText::_('Allow employer to post job on jomsocial from My Jobs layout'); ?></label>
            </div>
        </div>
        <div id="jsjob_configuration_wrapper">
            <label class="jobs-config-title stylelabeltop labelcolortop" for="jomsocial_allowpostresume">
                <?php echo JText::_('Allow Post Resume'); ?>
            </label>
            <div class="jobs-config-value">
                <?php
                echo JHTML::_('select.genericList', $yesno, 'jomsocial_allowpostresume', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['jomsocial_allowpostresume']);
                ?>
            </div>
            <div class="jobs-config-descript">
                <label class=" stylelabelbottom labelcolorbottom" for="jomsocial_allowpostresume"><?php echo JText::_('Allow job seeker to post resume on jomsocial from My Resumes layout'); ?></label>
            </div>
        </div>
    </div>
 </div>
