                     ...
                     <div id="jsjobs_left_main">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="folder_auto_approve">
                                <?php echo JText::_('Folder Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_goldcompany_button">
                                <?php echo JText::_('Show Add To Gold Company Button'); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_goldcompany_button', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['show_fe_goldcompany_button']); ?> 
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_goldcompany_button"><?php echo JText::_('Show hide frontend gold button form company listing'); ?></label>     
                            </div>
                        </div>
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_featuredcompany_button">
                                <?php echo JText::_('Show Add To Featured Company Button'); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_featuredcompany_button', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['show_fe_featuredcompany_button']); ?> 
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_featuredcompany_button"><?php echo JText::_('Show hide frontend featured button form company listing'); ?></label>     
                            </div>
                        </div>
                    ...
                    <div id="jsjobs_right_main">
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="goldcompany_autoapprove">
                                <?php echo JText::_('Gold Company Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="featuredcompany_autoapprove">
                                <?php echo JText::_('Featured Company Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="companygoldexpiryindays">
                                <?php echo JText::_('Gold company Expire In Days'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="companyfeaturedexpiryindays">
                                <?php echo JText::_('Featured company Expire In Days'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="goldjob_autoapprove">
                                <?php echo JText::_('Gold Job Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="featuredjob_autoapprove">
                                <?php echo JText::_('Featured job Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_goldjob_button">
                                <?php echo JText::_('Show Add To Gold Job Button '); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_goldjob_button', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['show_fe_goldjob_button']); ?> 
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_goldjob_button"><?php echo JText::_('Show hide frontend gold button form jobs listing'); ?></label>     
                            </div>
                        </div>
                        
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_featuredjob_button">
                                <?php echo JText::_('Show Add To Featured Job Button'); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_featuredjob_button', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['show_fe_featuredjob_button']); ?> 
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_featuredjob_button"><?php echo JText::_('Show hide frontend featured button form job listing'); ?></label>     
                            </div>
                        </div>
                 ...
                 <div id="jsjobs_left_main">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="visitor_can_edit_job">
                            <?php echo JText::_('Edit Job Posting'); ?>
                        </label>
                        <div class="jobs-config-value">
                        ...
                        <div class="jobs-config-descript">
                            <label class=" stylelabelbottom labelcolorbottom" for="visitor_can_edit_job"><?php echo JText::_('Visitor can edit his posted job'); ?></label>     
                        </div>
                    </div>
                ...
                <div class="headtext"><?php echo JText::_('Visitors Can View Employer Area'); ?></div>
                 ...
                 <div id="jsjobs_right_main">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        ...
                        <div class="jobs-config-value">
                           <?php echo JHTML::_('select.genericList', $showhide, 'visitorview_emp_resume', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['visitorview_emp_resume']); ?>
                        </div>
                        <div class="jobs-config-descript">
                            <label class=" stylelabelbottom labelcolorbottom" for="visitorview_emp_resume"><?php echo JText::_(''); ?></label>     
                        </div>
                    </div>
                 ...
                 <div id="jsjobs_left_main">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="box_newestresume">
                            <?php echo JText::_('Newest Resume Box'); ?>
                        </label>
                        <div class="jobs-config-value">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="box_appliedresume">
                            <?php echo JText::_('Applied Resume Box'); ?>
                        </label>
                        <div class="jobs-config-value">
                    ...
                    */ ?>
                    ...
                    <div id="jsjob_configuration_wrapper">
                        ...
                        <div class="jobs-config-value">
                            <?php echo JHTML::_('select.genericList', $showhide, 'formdepartment', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['formdepartment']); ?>
                        </div>
                        <div class="jobs-config-descript">
                            <label class=" stylelabelbottom labelcolorbottom" for="formdepartment"><?php echo JText::_(''); ?></label>     
                        </div>
                    </div>
                 ...
                 <div id="jsjobs_right_main">
                    ...
                    <div id="jsjob_configuration_wrapper" >
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="empregister">
                            <?php echo JText::_('Employer Registration'); ?>
                        </label>
                        <div class="jobs-config-value">
                 ...
                 <div id="jsjobs_left_main">
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="employer_resume_alert_fields">
                            <?php echo JText::_('What Include In Email'); ?>
                        </label>
                        <div class="jobs-config-value">
