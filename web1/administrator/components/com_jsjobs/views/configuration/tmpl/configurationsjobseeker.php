...
$captcha_type = array(
    '0' => array('value' => 1,
        'text' => JText::_('No')),
    '1' => array('value' => 2,
        'text' => JText::_('Own Captcha')),
    '2' => array('value' => 3,
        'text' => JText::_('Google reCaptcha')),);
                ...
                <div class="headtext"><?php echo JText::_('General Settings'); ?></div>
                     <div id="jsjobs_left_main">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="goldresume_autoapprove">
                                <?php echo JText::_('Gold Resume Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="featuredresume_autoapprove">
                                <?php echo JText::_('Featured Resume Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="resumegoldexpiryindays">
                                <?php echo JText::_('Gold Resume Expire In Days'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="resumefeaturedexpiryindays">
                                <?php echo JText::_('Featured Resume Expire In Days'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_applied_resume_status">
                                <?php echo JText::_('Show Applied Resume Status'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="jobalert_auto_approve">
                                <?php echo JText::_('Job Alert Auto Approve'); ?>
                            </label>
                            <div class="jobs-config-value">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_goldresume_button">
                                <?php echo JText::_('Show Add To Gold Resume Button'); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_goldresume_button', 'class="inputfieldsizeful inputbox"', 'value', 'text', $this->config['show_fe_goldresume_button']); ?>
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_goldresume_button"><?php echo JText::_('Show hide frontend add to gold button form resume listing'); ?></label>     
                            </div>
                        </div>
                    ...
                    <div id="jsjobs_right_main">
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            ...
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="vis_jslistjobshortlist"><?php echo JText::_('Controls the visibilty of apply now button in plugin'); ?></label>     
                            </div>
                        </div>
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="apllybuttonshow">
                                <?php echo JText::_('Apply Now Redirect Link'); ?>
                            </label>                            
                        ...
                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_featuredresume_button">
                                <?php echo JText::_('Show Add To Featured Resume Button'); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_featuredresume_button', 'class="inputfieldsizeful inputbox"', 'value', 'text', $this->config['show_fe_featuredresume_button']); ?>
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_featuredresume_button"><?php echo JText::_('Show hide frontend add to featured button form resume listing'); ?></label>     
                            </div>
                        </div>

                        <div id="jsjob_configuration_wrapper" >
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="show_fe_tellafriend_button">
                                <?php echo JText::_('Show Tall a Friend Button'); ?>
                            </label>
                            <div class="jobs-config-value">
                                <?php echo JHTML::_('select.genericList', $showhide, 'show_fe_tellafriend_button', 'class="inputfieldsizeful inputbox"', 'value', 'text', $this->config['show_fe_tellafriend_button']); ?>
                            </div>
                            <div class="jobs-config-descript">
                                <label class=" stylelabelbottom labelcolorbottom" for="show_fe_tellafriend_button"><?php echo JText::_('Show hide frontend tell a friend button on job listing'); ?></label>     
                            </div>
                        </div>
                 ...
                 <div id="jsjobs_left_main">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="jsactivejobs_graph">
                            <?php echo JText::_('Active Jobs Graph'); ?>
                        </label>
                        <div class="jobs-config-value">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="jsnewestjobs_box">
                            <?php echo JText::_('Suggested Jobs Box'); ?>
                        </label>
                        <div class="jobs-config-value">
                  ...
                  <div id="jsjob_configuration_wrapper">
                    ...
                    <div id="jsjob_configuration_wrapper" >
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="jsregister">
                            <?php echo JText::_('Job Seeker Registration'); ?>
                        </label>
                        <div class="jobs-config-value">
                    ...
                    <div id="jsjob_configuration_wrapper" >
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="listjobshortlist">
                            <?php echo JText::_('Short Listed Jobs'); ?>
                        </label>
                        <div class="jobs-config-value">
                 ...
                 <div id="jsjobs_left_main">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="vis_jsnewestjobs_box">
                            <?php echo JText::_('Newest Jobs Box'); ?>
                        </label>
                        <div class="jobs-config-value">
                 ...
                 <div id="jsjobs_left_main">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="visitor_can_add_resume">
                            <?php echo JText::_('Visitor Can Add New Resume'); ?>
                        </label>
                        <div class="jobs-config-value">
                     ...
                     <div id="jsjob_configuration_wrapper">
                            <label class="jobs-config-title stylelabeltop labelcolortop" for="overwrite_jobalert_settings">
                                <?php echo JText::_('Job Alert For Visitor'); ?>
                            </label>
                            <div class="jobs-config-value">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="visitor_show_login_message">
                            <?php echo JText::_('Show Login Message To Visitor'); ?>
                        </label>
                        <div class="jobs-config-value">
                        ...
                        <div class="jobs-config-descript">
                            <label class=" stylelabelbottom labelcolorbottom" for="visitor_show_login_message"><?php echo JText::_('Show login option to visitor on job apply'); ?></label>     
                        </div>
                    </div>
                </div><!-- left closed -->
                 ...
                 <div id="jsjobs_right_main">
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="resume_captcha">
                            <?php echo JText::_('Resume Captcha'); ?>
                        </label>
                        <div class="jobs-config-value">
                           <?php echo JHTML::_('select.genericList', $captcha_type, 'resume_captcha', 'class="inputfieldsizeful inputbox" ' . '', 'value', 'text', $this->config['resume_captcha']); ?>
                        </div>
                        <div class="jobs-config-descript">
                    ...
                    <div id="jsjob_configuration_wrapper">
                        <label class="jobs-config-title stylelabeltop labelcolortop" for="job_alert_captcha">
                            <?php echo JText::_('Job Alert Captcha'); ?>
                        </label>
                        <div class="jobs-config-value">
