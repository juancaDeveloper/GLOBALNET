...
class TlpteamViewTeams extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JHtmlSidebar::addFilter(
            ...
            'filter_department',
            JHtml::_('select.options', JHtml::_('category.options', 'com_tlpteam'), "value", "text", $this->state->get('filter.department'))
    ...
    protected function getSortFields()
    {
        ...
        'a.`department`' => JText::_('COM_TLPTEAM_TEAMS_DEPARTMENT'),
        ...
        'a.`phoneno`' => JText::_('COM_TLPTEAM_TEAMS_PHONENO'),
        ...
        'a.`access`' => JText::_('COM_TLPTEAM_TEAMS_ACCESS'),
        );
    }
