 ...
 */
class TlpteamViewSkills extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        TlpteamHelper::addSubmenu('skills');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_TLPTEAM_TITLE_SKILLS'), 'skills.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_tlpteam&view=skills');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_TLPTEAM_SKILLS_TITLE'),
