...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tlpteam&task=skills.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_tlpteam&view=skills'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.state', $listDirn, $listOrder); ?>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_TLPTEAM_SKILLS_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'skills.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_tlpteam&task=skill.edit&id='.(int) $item->id); ?>">
